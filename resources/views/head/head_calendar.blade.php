...
$(document).ready(function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: function(fetchInfo, successCallback, failureCallback) {
            ...
            // 1. Fetch Tasks
            $.ajax({
                url: '{{route("head.calendar.viewtaskdate")}}',
                type: 'GET',
                dataType: 'json',
            ...
            $.ajax({
                url: '{{route("head.calendar.viewprivateeventdate")}}',
                type: 'GET',
                dataType: 'json',
                success: function(response) {
            ...
            $.ajax({
                url: '{{route("head.calendar.viewdepartmenteventdate")}}',
                type: 'GET',
                dataType: 'json',
                success: function(response) {
                    if (response.status !== 'nothing') {
            ...
            $.ajax({
                url: '{{route("head.calendar.viewannouncementeventdate")}}',
                type: 'GET',
                dataType: 'json',
                success: function(response) {
                    if (response.status !== 'nothing') {
            ...
            Swal.fire({
                ...
                didOpen: () => {
                    ...
                    $('#eventFormDrag').submit(function(e) {
                        ...
                        $.ajax({
                            url: '{{route("head.calendar.saveevent")}}',
                            type: 'POST',
        ...
        eventClick: function(info) {
            ...
            if(event.extendedProps.source == 'task-calendar'){
                ...
                var observerTaskRoute = @json(route('head.lvtasks', ['task' => '__TASK_ID__']));
                ...
                var html_task = `
                    <div class="calendar-view-body p-0"
                        <div class=" row p-3 mb-2">
                            ...
                            <div class="w-100 my-2 col-12 text-center"><p><b>${event.title}</b></p></div><div class="w-100 my-2 col-12 text-center"><span><b class="text-primary">Description</b>: ${private.description}</span></div>
    ...
    $(document).on('click', '.removeEvent', function() {
        ...
        $.ajax({
            url: '{{route("head.calendar.removeevent")}}',
            type: 'POST',
            data: {
                event: event
