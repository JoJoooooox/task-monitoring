...
$(document).ready(function() {
    ...
    function setupCommonUI(isCreator, roomUrl, room_id = null) {
        ...
        if (isCreator) {
            const endMeetingBtn = createButton('End Meeting', 'x', async () => {
                try {
                    await $.ajax({
                        url: `{{ route('head.chat.removemeeting') }}`,
                        type: 'POST',
                        data: { room: room_id },
    ...
    $(document).on('click', '.convo-media-item', function() {
        ...
        $.ajax({
            url: `{{ route('head.chat.media', ['chat' => 'CHAT_ID']) }}`.replace('CHAT_ID', chatId),
            type: 'GET',
            success: function(response) {
                if(response.status === 'success') {
    ...
    function buildSeen(messageId, isMe, chatId) {
        $.ajax({
            url: "{{ route('head.chat.checkwhoseen') }}",
            type: "GET",
            data: {
                message: messageId
            },
    ...
    function buildTask(messageId, taskId, isMe, user_id){
        $.ajax({
            url: "{{ route('head.chat.gettaskinfo') }}",
            type: "GET",
            data: { task: taskId },
            dataType: 'json',
            success: function(response) {
                if (response.status === 'error') {
                    ...
                    if (response.task) {
                        ...
                        let viewUrl = "{{ route('head.lvtasks', ['task' => '__TASK_ID__']) }}".replace('__TASK_ID__', task.id);
                        const task_html = $(
                            `
    ...
    function checkMedia(messageId, isMe) {
        $.ajax({
            url: "{{ route('head.chat.checkmessageattachment') }}",
            type: "GET",
    ...
    function checkReplies(messageId, isMe) {
        $.ajax({
            url: "{{ route('head.chat.checkmessagereply') }}",
            type: "GET",
            data: {
                message: messageId
            },
    ...
    function checkWhoForward(messageId) {
        $.ajax({
            url: "{{ route('head.chat.checkwhoforward') }}",
            type: "GET",
            dataType: 'json',
            success: function(response) {
                if(response.status === 'error'){
    ...
    function reloadChatMessage() {
        if($('#chatDisplayId').length > 0){
            ...
            $.ajax({
                url: "{{ route('reloadhe.chat.message') }}",
                type: "POST",
                data: {
                    _token: "{{ csrf_token() }}",
    ...
    $(document).on('click', '#sendToUserMessage', function () {
        ...
        $.ajax({
            url: `{{ route('head.chat.sendmessage') }}`,
            type: 'POST',
            data: formData,
            processData: false, // Don't process the data
            contentType: false, // Don't set content type
    ...
    $(document).on('click', '.replyMessage', function() {
        ...
        $.ajax({
            url: `{{ route('head.chat.replieduser') }}`,
            type: 'GET',
            data: {
                message: message
            },
    ...
    $(document).on('click', '.editMessage', function() {
        ...
        $.ajax({
            url: `{{ route('head.chat.geteditmessage') }}`,
            type: 'GET',
            data: {
                message: message
            },
    ...
    $(document).on('click', '#submitEditMessage', function () {
        ...
        let formData = new FormData(form);
        $.ajax({
            url: `{{ route('head.chat.editmessage') }}`,
            type: 'POST',
            data: formData,
            processData: false, // Don't process the data
            contentType: false, // Don't set content type
    ...
    $(document).on('click', '.viewEditedMessage', function() {
        var message = $(this).data('message');
        $.ajax({
            url: `{{ route('head.chat.vieweditmessage') }}`,
            type: 'GET',
            data: {
                message: message
            },
    ...
    $(document).on('click', '.forwardMessage', function() {
        ...
        $.ajax({
            url: `{{ route('head.chat.viewmessagecontact') }}`,
            type: 'GET',
            data: {
                message: message,
                chat: chat
    ...
    $(document).on('click', '.submitForwardMessage', function() {
        ...
        $.ajax({
            url: `{{ route('head.chat.sendforwardmessage') }}`,
            type: 'POST',
            data: {
                message: message,
                chat: chat
    ...
    $(document).on('click', '.submitCreateGroup', function() {
        ...
        $.ajax({
            url: `{{ route('head.chat.creategroupmessage') }}`,
            type: 'POST',
            data: form,
            headers: {
                'X-CSRF-TOKEN': token // Add CSRF token
    ...
    $(document).on('click', '.submitUnsend', function() {
        ...
        $.ajax({
            url: `{{ route('head.chat.unsendmessage') }}`,
            type: 'POST',
            data: {
                message: message,
                type: parseInt(type)
    ...
    $(document).on('click', '.pinMessage', function() {
        ...
        var chat = $(this).data('chat');
        $.ajax({
            url: `{{ route('head.chat.pinmessage') }}`,
            type: 'POST',
            data: {
                message: message,
                chat: chat
    ...
    $(document).on('click', '.unpinMessage', function() {
        ...
        var chat = $(this).data('chat');
        $.ajax({
            url: `{{ route('head.chat.unpinmessage') }}`,
            type: 'POST',
            data: {
                message: message,
                chat: chat
    ...
    function reloadPinned() {
        ...
        $.ajax({
            url: "{{ route('reloadhe.chat.pinned') }}",
            type: "POST",
            data: {
                _token: "{{ csrf_token() }}",
    ...
    $(document).on('click', '.viewPinnedMessage', function() {
        ...
        $.ajax({
            url: `{{ route('head.chat.viewpinnedmessage') }}`,
            type: 'GET',
            data: {
                chat: chat
            },
    ...
    $(document).on('click', '.submit-nickname', function() {
        ...
        $.ajax({
            url: `{{ route('head.chat.setnickname') }}`,
            type: 'POST',
            data: form,
            headers: {
                'X-CSRF-TOKEN': token // Add CSRF token
    ...
    $(document).on('submit', '#convoPhotoForm', function(e) {
        ...
        const formData = new FormData(this);
        $.ajax({
            url: `{{ route('head.chat.setconvoimage') }}`,
            type: 'POST',
            data: formData,
            processData: false, // Don't process the data
            contentType: false, // Don't set content type
    ...
    $(document).on('click', '.clearConvoImage', function() {
        var chat = $(this).data('chat');
        $.ajax({
            url: `{{ route('head.chat.unsetconvoimage') }}`,
            type: 'POST',
            data: {
                chat: chat
            },
    ...
    $(document).on('submit', '#convoNameForm', function(e) {
        ...
        const formData = new FormData(this);
        $.ajax({
            url: `{{ route('head.chat.setconvoname') }}`,
            type: 'POST',
            data: formData,
            processData: false, // Don't process the data
            contentType: false,
    ...
    $(document).on('click', '.clearConvoName', function() {
        var chat = $(this).data('chat');
        $.ajax({
            url: `{{ route('head.chat.unsetconvoname') }}`,
            type: 'POST',
            data: {
                chat: chat
            },
    ...
    $(document).on('click', '.addMemberGroupSubmit', function() {
        ...
        var user = $(this).data('user');
        $.ajax({
            url: `{{ route('head.chat.addnewmembergroup') }}`,
            type: 'POST',
            data: {
                chat: chat,
                user: user
    ...
    $(document).on('click', '.toggleAsAdminChat', function(){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: `{{ route('head.chat.toggleasadmin') }}`,
                    type: 'POST',
                    data: {
                        chat: chat,
                        user: user,
    ...
    $(document).on('click', '.kickAsAdminChat', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // If user confirmed, proceed with AJAX request
                $.ajax({
                    url: `{{ route('head.chat.removefromgroup') }}`,
                    type: 'POST',
                    data: {
                        chat: chat,
                        user: user,
    ...
    $(document).on('click', '.leaveConversation', function(){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // If user confirmed, proceed with AJAX request
                $.ajax({
                    url: `{{ route('head.chat.leaveconversation') }}`,
                    type: 'POST',
                    data: {
                        chat: chat
                    },
    ...
    $(document).on('click', '.chatMuteSubmit', function() {
        ...
        $.ajax({
            url: `{{ route('head.chat.setmutedchat') }}`,
            type: 'POST',
            data: {
                chat_id: chat,
                muted: muted
    ...
    function loadMessages(chat, message, initialLoad = true) {
        ...
        $.ajax({
            url: `{{ route('head.chat.searchmessagevalue') }}`,
            type: 'POST',
            data: {
                chat: chat,
                message: message,
    ...
    $('#meetForm').on('submit', function(e) {
        ...
        const formData = new FormData(this);
        $.ajax({
            url: `{{ route('head.chat.savemeeting') }}`,
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
    ...
    $(window).on("beforeunload", function () {
        navigator.sendBeacon("{{ route('head.chat.removeishere') }}");
    });
});
</script>
@endsection