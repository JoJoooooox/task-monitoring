...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '#photoForm button[name="photoSubmit"]', function(){
            ...
            // AJAX request
            $.ajax({
                url: '{{ route("observer.profile.photo") }}', // The route defined in Laravel
        ...
        $(document).on('click', '#profileForm button[name="profileSubmit"]', function() {
            $.ajax({
                url: '{{ route("observer.profile.pinfo") }}', // The route defined in Laravel
                type: 'POST', // Method type
        ...
        $(document).on('click', '#basicForm button[name="basicSubmit"]', function() {
            $.ajax({
                url: '{{ route("observer.profile.binfo") }}', // The route defined in Laravel
                type: 'POST', // Method type
        ...
        $(document).on('click', 'button[name="passSubmit"]', function(e) {
            ...
            $.ajax({
                url: '{{ route("observer.profile.update") }}',
                type: 'POST',
                data: form.serialize(),
                dataType: 'json',
                success: function(response) {
