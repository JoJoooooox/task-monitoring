...
<head>
	...
	<title>Observer Forgot Password</title>
							...
							<div class="row">
                                ...
                                <div class="auth-form-wrapper px-4 py-5">
                                    ...
                                    <div class="choicesDiv">
                                        ...
                                        <a href="{{ route('observer.login') }}" class="btn btn-outline-primary btn-icon-text mb-2 mb-md-0">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.sendOtpEmail', function() {
                ...
                $.ajax({
                    url: '{{ route("observer.sendotpemail") }}', // Adjust route as necessary
                    method: 'POST',
                    data: {
                        email: email
                    },
            ...
            $(document).on('click', '.sendOtpPhone', function() {
                ...
                $.ajax({
                    url: '{{ route("observer.sendotpphone") }}', // Adjust route as necessary
                    method: 'POST',
                    data: {
                        phone: phone
                    },
            ...
            $(document).on('click', '.submitNewPassword', function() {
                ...
                $.ajax({
                    url: '{{ route("observer.submitnewpass") }}', // Adjust route as necessary
                    method: 'POST',
                    data: {
                        new_pass: newPass,
                        user_id: user_id,
