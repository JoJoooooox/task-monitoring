<nav class="sidebar">
    <div class="sidebar-header">
        <a href="{{ route('observer.dashboard') }}" class="sidebar-brand">
        TRI<span>BO</span>
        </a>
    ...
    <div class="sidebar-body">
        ...
        <li class="nav-item">
            <a href="{{ route('observer.dashboard') }}" class="nav-link">
        ...
        @endif
        <li class="nav-item">
            <a href="{{ route('observer.chat') }}" class="nav-link">
