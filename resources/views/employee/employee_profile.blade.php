...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '#photoForm button[name="photoSubmit"]', function(){
            ...
            // AJAX request
            $.ajax({
                url: '{{ route("employee.profile.photo") }}', // The route defined in Laravel
        ...
        $(document).on('click', '#profileForm button[name="profileSubmit"]', function() {
            $.ajax({
                url: '{{ route("employee.profile.pinfo") }}', // The route defined in Laravel
                type: 'POST', // Method type
        ...
        $(document).on('click', '#basicForm button[name="basicSubmit"]', function() {
            $.ajax({
                url: '{{ route("employee.profile.binfo") }}', // The route defined in Laravel
                type: 'POST', // Method type
