...
$(document).ready(function(){
    ...
    $("#printButton").click(function () {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                printWindow.document.write('<link rel="stylesheet" href="/assets/custom-css/employee.css">');
    ...
    function liveTask(active = null){
        ...
        $.ajax({
            url: '{{ route("employee.tasks.gptasks") }}',
            method: 'GET',
            data: {
                task: id
            },
    ...
    function getRadioField(id) {
        return new Promise(function (resolve, reject) {
            $.ajax({
                url: '{{ route("employee.tasks.printgetradio") }}',
                method: 'GET',
                data: { id: id },
                dataType: 'json',
                success: function(response) {
    ...
    function getDownField(id) {
        return new Promise(function (resolve, reject) {
            $.ajax({
                url: '{{ route("employee.tasks.printgetdown") }}',
                method: 'GET',
                data: { id: id },
                dataType: 'json',
                success: function(response) {
    ...
    function reloadOngoingDiv() {
        var id = $('#panelTask').data('task');
        $.ajax({
            url: "{{ route('employee.tasks.liveprintreloading') }}",
            type: "POST",
            noLoading: true,
            data: {
                _token: "{{ csrf_token() }}",
