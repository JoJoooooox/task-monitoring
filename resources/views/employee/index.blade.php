...
<div class="page-content">
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">Welcome to Employee Dashboard "{{ Auth::user()->name }}"</h4>
        </div>
    ...
    <div class="row-container">
        <div class="row row first-row">
            <div class="col-xl-12 grid-margin stretch-card">
                <div class="card div-hover">
                    <div class="card-body">
                        <h6 class="card-title">My Task</h6>
...
$(document).ready(function() {
    function pageContainer(){
        ...
        Morris.Donut({
            element: 'taskDonut',
            data: [
                { label: "Holding", value: {{ Auth::user()->department ? $ongoing->count() : 0}} },
    ...
    function reloadOngoingDiv() {
        $.ajax({
            url: "{{ route('reloademp.myongoing.div') }}",
            type: "POST",
            noLoading: true,
            data: {
    ...
    setInterval(reloadOngoingDiv, 2000);
