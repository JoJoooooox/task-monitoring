                                                                        ...
                                                                        <div class="up-container">
                                                                            ...
                                                                            <div class="upload-box">
                                                                                ...
                                                                                <label for="file-upload" class="custom-file-upload">
                                                                                    Click to upload<br>
                                                                                    <input type="file" id="file-upload" name="file_'.$content->id.'_'.$content->task_id.'" class="file drop_'.$content->id.'" accept="*">
...
$(document).ready(function(){
    ...
    function saveFieldInput(page, task, from){
        return new Promise((resolve, reject) => {
            ...
            $.ajax({
                url: '{{ route("employee.etasks.save") }}',
                method: 'POST',
                data: formData,
    ...
    function updateUserStatus(eventType, isBeforeUnload = false){
        ...
        if (isBeforeUnload) {
            navigator.sendBeacon("{{ route('employee.etasks.userstatuschecking') }}", formData);
        } else {
            $.ajax({
                url: '{{ route("employee.etasks.userstatuschecking") }}',
                method: 'POST',
                noLoading: true,
                data: formData,
                dataType: 'json',
