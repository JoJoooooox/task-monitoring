...
$(document).ready(function() {
    ...
    function setupCommonUI(isCreator, roomUrl, room_id = null) {
        ...
        if (isCreator) {
            const endMeetingBtn = createButton('End Meeting', 'x', async () => {
                try {
                    await $.ajax({
                        url: `{{ route('employee.chat.removemeeting') }}`,
                        type: 'POST',
                        data: { room: room_id },
    ...
    function chatDisplay(chat, loadMore = false){
        ...
        $.ajax({
            url: "{{ route('employee.chat.viewchats') }}",
            type: "GET",
            data: {
                chat: chat,
                page: currentPage
    ...
    $(document).on('click', '.convo-media-item', function() {
        ...
        $.ajax({
            url: `{{ route('employee.chat.media', ['chat' => 'CHAT_ID']) }}`.replace('CHAT_ID', chatId),
            type: 'GET',
            success: function(response) {
                if(response.status === 'success') {
    ...
    function buildSeen(messageId, isMe, chatId) {
        $.ajax({
            url: "{{ route('employee.chat.checkwhoseen') }}",
            type: "GET",
            data: {
                message: messageId
            },
    ...
    function checkReplies(messageId, isMe) {
        $.ajax({
            url: "{{ route('employee.chat.checkmessagereply') }}",
            type: "GET",
            data: {
                message: messageId
            },
    ...
    function checkWhoForward(messageId) {
        $.ajax({
            url: "{{ route('employee.chat.checkwhoforward') }}",
            type: "GET",
            dataType: 'json',
            success: function(response) {
                if(response.status === 'error'){
    ...
    $(document).on('click', '.replyMessage', function() {
        ...
        $.ajax({
            url: `{{ route('employee.chat.replieduser') }}`,
            type: 'GET',
            data: {
                message: message
            },
    ...
    $(document).on('click', '.editMessage', function() {
        ...
        $.ajax({
            url: `{{ route('employee.chat.geteditmessage') }}`,
            type: 'GET',
            data: {
                message: message
            },
    ...
    $(document).on('click', '#submitEditMessage', function () {
        ...
        let formData = new FormData(form);
        $.ajax({
            url: `{{ route('employee.chat.editmessage') }}`,
            type: 'POST',
            data: formData,
            processData: false, // Don't process the data
            contentType: false, // Don't set content type
    ...
    $(document).on('click', '.viewEditedMessage', function() {
        var message = $(this).data('message');
        $.ajax({
            url: `{{ route('employee.chat.vieweditmessage') }}`,
            type: 'GET',
            data: {
                message: message
            },
    ...
    $(document).on('click', '.forwardMessage', function() {
        ...
        $.ajax({
            url: `{{ route('employee.chat.viewmessagecontact') }}`,
            type: 'GET',
            data: {
                message: message,
                chat: chat
    ...
    $(document).on('click', '.submitForwardMessage', function() {
        ...
        $.ajax({
            url: `{{ route('employee.chat.sendforwardmessage') }}`,
            type: 'POST',
            data: {
                message: message,
                chat: chat
    ...
    $(document).on('click', '.submitCreateGroup', function() {
        ...
        $.ajax({
            url: `{{ route('employee.chat.creategroupmessage') }}`,
            type: 'POST',
            data: form,
            headers: {
                'X-CSRF-TOKEN': token // Add CSRF token
    ...
    $(document).on('click', '.submitUnsend', function() {
        ...
        $.ajax({
            url: `{{ route('employee.chat.unsendmessage') }}`,
            type: 'POST',
            data: {
                message: message,
                type: parseInt(type)
    ...
    $(document).on('click', '.pinMessage', function() {
        ...
        var chat = $(this).data('chat');
        $.ajax({
            url: `{{ route('employee.chat.pinmessage') }}`,
            type: 'POST',
            data: {
                message: message,
                chat: chat
    ...
    $(document).on('click', '.unpinMessage', function() {
        ...
        var chat = $(this).data('chat');
        $.ajax({
            url: `{{ route('employee.chat.unpinmessage') }}`,
            type: 'POST',
            data: {
                message: message,
                chat: chat
    ...
    function reloadPinned() {
        ...
        $.ajax({
            url: "{{ route('reloademp.chat.pinned') }}",
            type: "POST",
            data: {
                _token: "{{ csrf_token() }}",
    ...
    $(document).on('click', '.viewPinnedMessage', function() {
        ...
        $.ajax({
            url: `{{ route('employee.chat.viewpinnedmessage') }}`,
            type: 'GET',
            data: {
                chat: chat
            },
    ...
    $(document).on('click', '.submit-nickname', function() {
        ...
        $.ajax({
            url: `{{ route('employee.chat.setnickname') }}`,
            type: 'POST',
            data: form,
            headers: {
                'X-CSRF-TOKEN': token // Add CSRF token
    ...
    $(document).on('submit', '#convoPhotoForm', function(e) {
        ...
        const formData = new FormData(this);
        $.ajax({
            url: `{{ route('employee.chat.setconvoimage') }}`,
            type: 'POST',
            data: formData,
            processData: false, // Don't process the data
            contentType: false, // Don't set content type
    ...
    $(document).on('click', '.clearConvoImage', function() {
        var chat = $(this).data('chat');
        $.ajax({
            url: `{{ route('employee.chat.unsetconvoimage') }}`,
            type: 'POST',
            data: {
                chat: chat
            },
    ...
    $(document).on('submit', '#convoNameForm', function(e) {
        ...
        const formData = new FormData(this);
        $.ajax({
            url: `{{ route('employee.chat.setconvoname') }}`,
            type: 'POST',
            data: formData,
            processData: false, // Don't process the data
            contentType: false,
    ...
    $(document).on('click', '.clearConvoName', function() {
        var chat = $(this).data('chat');
        $.ajax({
            url: `{{ route('employee.chat.unsetconvoname') }}`,
            type: 'POST',
            data: {
                chat: chat
            },
    ...
    $(document).on('click', '.addMemberGroupSubmit', function() {
        ...
        var user = $(this).data('user');
        $.ajax({
            url: `{{ route('employee.chat.addnewmembergroup') }}`,
            type: 'POST',
            data: {
                chat: chat,
                user: user
    ...
    $(document).on('click', '.toggleAsAdminChat', function(){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: `{{ route('employee.chat.toggleasadmin') }}`,
                    type: 'POST',
                    data: {
                        chat: chat,
                        user: user,
    ...
    $(document).on('click', '.kickAsAdminChat', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // If user confirmed, proceed with AJAX request
                $.ajax({
                    url: `{{ route('employee.chat.removefromgroup') }}`,
                    type: 'POST',
                    data: {
                        chat: chat,
                        user: user,
    ...
    $(document).on('click', '.leaveConversation', function(){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // If user confirmed, proceed with AJAX request
                $.ajax({
                    url: `{{ route('employee.chat.leaveconversation') }}`,
                    type: 'POST',
                    data: {
                        chat: chat
                    },
    ...
    $(document).on('click', '.chatMuteSubmit', function() {
        ...
        $.ajax({
            url: `{{ route('employee.chat.setmutedchat') }}`,
            type: 'POST',
            data: {
                chat_id: chat,
                muted: muted
    ...
    function loadMessages(chat, message, initialLoad = true) {
        ...
        $.ajax({
            url: `{{ route('employee.chat.searchmessagevalue') }}`,
            type: 'POST',
            data: {
                chat: chat,
                message: message,
    ...
    $(window).on("beforeunload", function () {
        navigator.sendBeacon("{{ route('employee.chat.removeishere') }}");
    });
});
</script>
@endsection