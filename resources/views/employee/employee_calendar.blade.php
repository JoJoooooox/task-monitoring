...
$(document).ready(function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: function(fetchInfo, successCallback, failureCallback) {
            ...
            if(hasDepartment == 'yes'){
                $.ajax({
                    url: '{{route("employee.calendar.viewtaskdate")}}',
                    type: 'GET',
                    dataType: 'json',
            ...
            $.ajax({
                url: '{{route("employee.calendar.viewprivateeventdate")}}',
                type: 'GET',
                dataType: 'json',
                success: function(response) {
            ...
            if(hasDepartment == 'yes'){
                ...
                $.ajax({
                    url: '{{route("employee.calendar.viewdepartmenteventdate")}}',
                    type: 'GET',
                    dataType: 'json',
                    success: function(response) {
                        if (response.status !== 'nothing') {
            ...
            $.ajax({
                url: '{{route("employee.calendar.viewannouncementeventdate")}}',
                type: 'GET',
                dataType: 'json',
                success: function(response) {
                    if (response.status !== 'nothing') {
            ...
            Swal.fire({
                ...
                didOpen: () => {
                    ...
                    $('#eventFormDrag').submit(function(e) {
                        ...
                        $.ajax({
                            url: '{{route("employee.calendar.saveevent")}}',
                            type: 'POST',
        ...
        eventClick: function(info) {
            ...
            if(event.extendedProps.source == 'task-calendar'){
                ...
                var observerTaskRoute = @json(route('employee.lvtasks', ['task' => '__TASK_ID__']));
    ...
    $(document).on('click', '.removeEvent', function() {
        ...
        $.ajax({
            url: '{{route("employee.calendar.removeevent")}}',
            type: 'POST',
            data: {
                event: event
