                                                            ...
                                                            <tbody>
                                                                @if($row->task)
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="action-buttons">
                                                                            <a class="btn btn-primary mx-1 btn-hover" href="{{ route('admin.lvtasks', ['task' => $task->id]) }}"><i data-feather="eye" class="icon-sm icon-wiggle"></i></a>
                                                                        </td>
                                                                    </tr>
                                                                    @endforeach
                                                                @endif
...
$(document).ready(function() {
    ...
    $(document).on('click', '#departmentForm button[name="createSubmit"]', function() {
        ...
        $.ajax({
            url: '{{ route("admin.department.add") }}',
            method: 'POST',
    ...
    function viewList(id){
        $.ajax({
            url: '{{ route("admin.department.user") }}',
            type: 'GET',
            dataType: 'json',
            success: function(response){
                var listHtml = '';
    ...
    function viewHead(id){
        $.ajax({
            url: '{{ route("admin.department.head") }}',
            type: 'GET',
            data:{
                id: id
            },
    ...
    function viewMember(id){
        $.ajax({
            url: '{{ route("admin.department.member") }}',
            type: 'GET',
            data:{
                id: id
            },
    ...
    $(document).on('click', '#addMember', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: '{{ route("admin.department.assign") }}',
                    method: 'POST',
                    data: {
                        department_id: dept,
                        user_id: user
    ...
    $(document).on('click', '#removeHead', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // If user confirmed, proceed with AJAX request
                $.ajax({
                    url: '{{ route("admin.department.remove") }}',
                    method: 'POST',
                    data: {
                        department_id: dept,
                        user_id: user
    ...
    function viewHeadDept(id){
        $.ajax({
            url: '{{ route("admin.department.vhead") }}',
            type: 'GET',
            data:{
                id: id
            },
    ...
    function viewMemberDept(id){
        $.ajax({
            url: '{{ route("admin.department.vmember") }}',
            type: 'GET',
            data:{
                id: id
            },
    ...
    $(document).on('click', '#editDepartment', function() {
        ...
        $.ajax({
            url: '{{ route("admin.department.edept") }}',
            type: 'GET',
            data:{
                id: id
            },
    ...
    $(document).on('click', '#deleteDepartment', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // If user confirmed, proceed with AJAX request
                $.ajax({
                    url: '{{ route("admin.department.rdept") }}',
                    method: 'POST',
                    data: {
                        id: id,
                    },
    ...
    function viewUserDept(user, dept){
        ...
        $.ajax({
            url: '{{ route("admin.department.vuser") }}',
            method: 'GET',
            data: {
                user: user,
                dept: dept
