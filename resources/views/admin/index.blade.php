...
<div class="page-content" id="page">
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">Welcome to Admin Dashboard "{{ Auth::user()->name }}"</h4>
        </div>
        <div class="d-flex align-items-center flex-wrap text-nowrap">
            <div class="input-group flatpickr w-100 me-2 mb-2 mb-md-0" id="dashboardDate">
...
$(document).ready(function() {
    function pageContainer(){
        $('#page').load(location.href + " #page > *", function() {
            ...
            if ($('#userDonut').length) {
                ...
                Morris.Donut({
                    element: 'userDonut',  // This should match the ID of the container
                    data: [
                    ...
                    colors: ['#ff33cc', '#9966ff', '#3399ff', '#66ffcc', '#ffff66'],  // Optional: Custom colors
    ...
    function reloadOngoingDiv() {
        $.ajax({
            url: "{{ route('reloadad.myongoing.div') }}",
            type: "POST",
            noLoading: true,
            data: {
