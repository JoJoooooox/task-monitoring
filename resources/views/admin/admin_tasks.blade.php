                                                    ...
                                                    @foreach($distReqView as $row)
                                                        <tr id="distReqRow_{{$row->id}}">
                                                            ...
                                                            <td class="action-buttons">
                                                                ...
                                                                <a class="btn btn-primary mx-1 btn-hover" href="{{ route('admin.lvtasks', ['task' => $row->task_id]) }}"><i data-feather="eye" class="icon-sm icon-wiggle"></i></a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                @endif
                                                ...
                                                @foreach($dist as $row)
                                                    <tr id="distRow_{{$row->id}}">
                                                        ...
                                                        <td class="action-buttons">
                                                            ...
                                                            <a class="btn btn-primary mx-1 btn-hover" href="{{ route('admin.lvtasks', ['task' => $row->id]) }}"><i data-feather="eye" class="icon-sm icon-wiggle"></i></a>
                                                            <a class="btn btn-primary mx-1 btn-hover" href="{{ route('admin.ptasks', ['task' => $row->id]) }}"><i data-feather="printer" class="icon-sm icon-wiggle"></i></a>
...
//region Code
    ...
    function reloadToCheckDiv() {
        $.ajax({
            url: "{{ route('reloadad.tocheck.div') }}",
            type: "POST",
            noLoading: true,
            data: {
                _token: "{{ csrf_token() }}", // CSRF token for Laravel
                ...
                if (response.status === 'initial_load') {
                    ...
                    if (response.tasks && response.tasks.length > 0) {
                        response.tasks.forEach(task => {
                            ...
                            let taskId = task.id;
                            let viewUrl = "{{ route('admin.lvtasks', ['task' => '__TASK_ID__']) }}".replace('__TASK_ID__', taskId);
    ...
    function reloadComplete() {
        $.ajax({
            url: "{{ route('reloadad.complete.div') }}",
            type: "POST",
            noLoading: true,
            data: {
                _token: "{{ csrf_token() }}", // CSRF token for Laravel
    ...
    function reloadDistribute() {
        $.ajax({
            url: "{{ route('reloadad.distribute.div') }}",
            type: "POST",
            noLoading: true,
            data: {
                _token: "{{ csrf_token() }}", // CSRF token for Laravel
                ...
                if (response.status === 'initial_load') {
                    ...
                    if (response.tasks && response.tasks.length > 0) {
                        ...
                        response.tasks.forEach(task => {
                            ...
                            let taskId = task.id;
                            let viewUrl = "{{ route('admin.lvtasks', ['task' => '__TASK_ID__']) }}".replace('__TASK_ID__', taskId);
                            let printUrl = "{{ route('admin.ptasks', ['task' => '__TASK_ID__']) }}".replace('__TASK_ID__', taskId);
                            const rowNode = table.row.add([
                                task.title,
                                `
                                <td class="action-buttons">
    ...
    function reloadDistributeReq() {
        $.ajax({
            url: "{{ route('reloadad.distributereq.div') }}",
            type: "POST",
            noLoading: true,
            data: {
                _token: "{{ csrf_token() }}", // CSRF token for Laravel
    ...
    function reloadOvertimeRequest() {
        $.ajax({
            url: "{{ route('reloadad.overtimereq.div') }}",
            type: "POST",
            noLoading: true,
            data: {
                _token: "{{ csrf_token() }}", // CSRF token for Laravel
    ...
    function assign_solo(id, name, dept){
        ...
        $.ajax({
            url: '{{ route("admin.tasks.vlsatask") }}',
            method: 'GET',
            data: {
                dept: dept
            },
    ...
    function assign_group(id, name, dept, assigning = 0){
        $.ajax({
            url: '{{ route("admin.tasks.vlgatask") }}',
            method: 'GET',
            data: {
                dept: dept,
                temp: id,
    ...
    $(document).on('click', '.submitGroupTempAssign', function() {
        ...
        $.ajax({
            url: '{{ route("admin.tasks.atagtask") }}',
            method: 'POST',
            data: {
                temp: temp,
                user: user
    ...
    $(document).on('click', '.removeMemberTempoList', function() {
        ...
        $.ajax({
            url: '{{ route("admin.tasks.rtagtask") }}',
            method: 'POST',
            noLoading: true,
            data: {
                temp: temp,
    ...
    $(document).on('click', '#approveTask', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("admin.tasks.approvetask") }}',
                    method: 'POST',
                    data: {
                        task: task
                    },
    ...
    $(document).on('click', '#declineTask', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: '{{ route("admin.tasks.declinetask") }}',
                    method: 'POST',
                    data: {
                        task: task,
    ...
    $(document).on('click', '#approveTaskDistribution', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("admin.tasks.adisttask") }}',
                    method: 'POST',
                    data: {
                        dist: dist
                    },
    ...
    $(document).on('click', '#declineTaskDistribution', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("admin.tasks.ddisttask") }}',
                    method: 'POST',
                    data: {
                        dist: dist
                    },
    ...
    $(document).on('click', '#submitManuallyDistribute', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("admin.tasks.disttask") }}',
                    method: 'POST',
                    data: form + '&cont=0',
                    dataType: 'json',
                    headers: {
    ...
    $(document).on('click', '#approveAllTaskDistribution', function() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("admin.tasks.aadisttask") }}',
                    method: 'POST',
                    data: {
                        dist: 0
                    },
    ...
    $(document).on('click', '#declineAllTaskDistribution', function() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("admin.tasks.dadisttask") }}',
                    method: 'POST',
                    data: {
                        dist: 0
                    },
    ...
    function link_new_task(task, assign = 0){
        $('#linkNewDisplay').html('');
        $.ajax({
            url: '{{ route("admin.tasks.vnttlink") }}',
            method: 'GET',
            data: {
                task: task
            },
            ...
            success: function(response) {
                ...
                $(document).on('change', '#templates', function(){
                    ...
                    if(assign === 0){
                        ...
                        $.ajax({
                            url: '{{ route("admin.tasks.checklinktemp") }}',
                            method: 'GET',
                            data: {
                                task: taskValue
                            },
                                ...
                                if(response.status === 'exist'){
                                    Swal.fire({
                                        ...
                                        if (result.isConfirmed) {
                                            ...
                                            $.ajax({
                                                url: '{{ route("admin.tasks.removelinktemp") }}',
                                                method: 'POST',
                                                data: {
                                                    task: taskValue,
                                                },
    ...
    $(document).on('click', '.submitMemberLinkTempoList', function() {
        ...
        $.ajax({
            url: '{{ route("admin.tasks.addmemberlinktemp") }}',
            method: 'POST',
            noLoading: true,
            data: {
                task: task,
    ...
    $(document).on('click', '.removeMemberLinkTempoList', function() {
        ...
        $.ajax({
            url: '{{ route("admin.tasks.removememberlinktemp") }}',
            method: 'POST',
            noLoading: true,
            data: {
                task: task,
    ...
    $(document).on('click', '.submitSoloLink', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("admin.tasks.linkandassigntask") }}',
                    method: 'POST',
                    data: form,
                    dataType: 'json',
                    headers: {
    ...
    $(document).on('click', '.submitGroupLink', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("admin.tasks.grouplinkandassigntask") }}',
                    method: 'POST',
                    data: form,
                    dataType: 'json',
                    headers: {
    ...
    $(document).on('click', '.linkToOngoingTask', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("admin.tasks.linkandassignongoingtask") }}',
                    method: 'POST',
                    data: {
                        task: task,
                        link: link
...
//region Link Task
    ...
    $(document).on('click', '#viewLinkedTask', function() {
        var task = $(this).data('task');
        window.location.href = `/admin/lvtasks/${task}`;
    });
...
//region User Statistic
    ...
    $(document).on('click', '#viewUserStatusStatistic', function() {
        ...
        $.ajax({
            url: '{{ route("admin.tasks.viewstatistic") }}',
            method: 'GET',
            data: {
                task: task
            },
    ...
    $(document).on('click', '#emergencyButton', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("admin.tasks.setemergencyuserstatus") }}',
                    method: 'POST',
                    data: {
                        task: task
                    },
...
//region Working Time
    ...
    $(document).on('click', '.acceptOvertimeBtn', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("admin.tasks.acceptovertimerequest") }}',
                    method: 'POST',
                    data: {
                        task: task
                    },
    ...
    $(document).on('click', '.declineOvertimeBtn', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("admin.tasks.declineovertimerequest") }}',
                    method: 'POST',
                    data: {
                        task: task
                    },
...
//region Chat Task Member
    ...
    $('#messageContactForm').on('submit', function (e) {
        ...
        $.ajax({
            url: `{{ route('admin.chat.sendtaskcontactmessage') }}`,
            type: 'POST',
            noLoading: true,
            data: formData,
...
//region Archive Task
    ...
    $(document).on('click', '.archiveDistributeTask', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("admin.tasks.archivedistributedtask") }}',
                    method: 'POST',
                    data: {
                        task: task
                    },
    ...
    $(document).on('click', '.archiveCompletedTask', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("admin.tasks.archivecompletedtask") }}',
                    method: 'POST',
                    data: {
                        task: task
                    },
    ...
    $(document).on('click', '#retrieveTask', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("admin.tasks.retrievetask") }}',
                    method: 'POST',
                    data: {
                        task: task
                    },
    ...
    $(document).on('click', '.deleteTask', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("admin.tasks.deletetask") }}',
                    method: 'POST',
                    data: {
                        task: task
                    },
    ...
    $(document).on('click', '#retrieveTemp', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("admin.tasks.retrievetemp") }}',
                    method: 'POST',
                    data: {
                        temp: temp
                    },
    ...
    $(document).on('click', '.deleteTemp', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("admin.tasks.deletetemp") }}',
                    method: 'POST',
                    data: {
                        temp: temp
                    },
