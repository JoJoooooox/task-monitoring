                ...
                <div id="modalBody2" class="modal-body">
                    <form id="eventForm">
                        ...
                        <select class="form-select convo-info-text mb-2" id="eventType" aria-label="Default select example">
                            <option selected value="private">Private (Self Event)</option>
                        </select>
...
$(document).ready(function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: function(fetchInfo, successCallback, failureCallback) {
            ...
            if(hasDepartment == 'yes'){
                $.ajax({
                    url: '{{route("intern.calendar.viewtaskdate")}}',
                    type: 'GET',
                    dataType: 'json',
            ...
            $.ajax({
                url: '{{route("intern.calendar.viewprivateeventdate")}}',
                type: 'GET',
                dataType: 'json',
                success: function(response) {
            ...
            if(hasDepartment == 'yes'){
                ...
                $.ajax({
                    url: '{{route("intern.calendar.viewdepartmenteventdate")}}',
                    type: 'GET',
                    dataType: 'json',
                    success: function(response) {
                        if (response.status !== 'nothing') {
            ...
            $.ajax({
                url: '{{route("intern.calendar.viewannouncementeventdate")}}',
                type: 'GET',
                dataType: 'json',
                success: function(response) {
                    if (response.status !== 'nothing') {
            ...
            Swal.fire({
                ...
                didOpen: () => {
                    ...
                    $('#eventFormDrag').submit(function(e) {
                        ...
                        $.ajax({
                            url: '{{route("intern.calendar.saveevent")}}',
                            type: 'POST',
        ...
        eventClick: function(info) {
            ...
            if(event.extendedProps.source == 'task-calendar'){
                ...
                var observerTaskRoute = @json(route('intern.lvtasks', ['task' => '__TASK_ID__']));
    ...
    $(document).on('click', '.removeEvent', function() {
        ...
        $.ajax({
            url: '{{route("intern.calendar.removeevent")}}',
            type: 'POST',
            data: {
                event: event
