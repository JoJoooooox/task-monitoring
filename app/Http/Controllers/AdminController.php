...
class AdminController extends Controller
{
    ...
    public function AdminDashboardGetAllChats(){
        $userId = Auth::id();
    ...
    public function AdminDashboardGetAllNotification(Request $request){
    ...
    public function AdminDashboardMarkAsReadedNotification(Request $request){
    ...
    public function AdminDashboardClearNotification(Request $request){
    ...
    public function AdminDashboard(){
        ...
        $headCount = User::where('role', 'head')->count();
    ...
    public function AdminSendOtpEmail(Request $request){
    ...
    public function AdminSendOtpPhone(Request $request){
        if(isset($request->otp)){
            $otp = $request->otp;
    ...
    public function AdminSubmitNewPass(Request $request){
...
//region tTask
    ...
    public function AdminTasks(){
        ...
        $temp = Task_templates::where('is_archived', 0)->get();
        foreach ($temp as $row) {
        ...
        return view('admin.admin_tasks', compact('department', 'temp', 'ongoing', 'tocheck', 'complete', 'dist', 'distReq', 'distReqView', 'department_dist', 'ongoingLink', 'linked', 'requestOvertime', 'archived', 'archivedTemp'));
    }
    ...
    public function AdminTasksEditTemplate(){
    ...
    public function AdminTasksEditInfoTemplate(Request $request){
        $id = $request->id;
    ...
    public function AdminTasksAddPage(Request $request){
    ...
    public function AdminTasksSavePageTitle(Request $request){
        $validator = Validator::make($request->all(), [
    ...
    public function AdminTasksSaveTaskInfo(Request $request){
        $validator = Validator::make($request->all(), [
    ...
    public function AdminTasksRemovePage(){
    ...
    public function AdminTasksAddField(){
    ...
    public function AdminTasksSaveFieldInput(Request $request){
        $validator = Validator::make($request->all(), [
    ...
    public function AdminTasksGetOptionRadio(Request $request){
        // Fetch the field
    ...
    public function AdminTasksGetOptionDown(Request $request){
        // Fetch the field
        $field = Task_templates_fields::find($request->id);
    ...
    public function AdminTasksRemoveFieldRow(Request $request){
        $field = Task_templates_fields::find($request->id);
        $field->delete();
    ...
    public function AdminTasksEditFieldTask(Request $request){
        $id = $request->content;
    ...
    public function AdminTasksChangeStepperTask(Request $request){
        $temp = Task_templates::find($request->id);
    ...
    public function AdminTasksViewDistributeTaskDepartment(Request $request){
        $temp = Task_templates::find($request->id);
    ...
    public function AdminTasksCheckDistributeTaskDepartment(Request $request){
        $temp = $request->temp;
        $dept = $request->dept;
    ...
    public function AdminTasksSubmitDistributeTaskDepartment(Request $request){
        $temp = $request->temp;
        $dept = $request->dept;
    ...
    public function AdminTasksViewListSoloAssignTask(Request $request){
        $id = $request->dept;
    ...
    public function AdminTasksSubmitAssignSoloTask(Request $request){
        $validator = Validator::make($request->all(), [
            'due' => ['required'],
        ]);
    ...
    public function AdminTasksCreate(Request $request){
        $validator = Validator::make($request->all(), [
            'title' => ['required', 'string'],
    ...
    public function AdminTasksViewListGroupAssignTask(Request $request){
    ...
    public function AdminTasksAddTemporaryAssignGroupTask(Request $request){
    ...
    public function AdminTasksRemoveTemporaryAssignGroupTask(Request $request){
        Task_tempo_group::where('user_id', $request->user)->where('template_id', $request->temp)->where('adder_id', Auth::user()->id)->delete();
        return response()->json(['status' => 'success']);
    }

    public function AdminTasksSubmitAssignGroupTask(Request $request){
        $validator = Validator::make($request->all(), [
            'due' => ['required'],
        ]);
    ...
    public function AdminTasksArchiveTemplate(Request $request){
    ...
    public function AdminTasksRetrievetemp(Request $request){
    ...
    public function AdminTasksDeletetemp(Request $request){
        $template = Task_templates::find($request->temp);
    ...
    public function AdminLiveViewTasks($task){
        $info = Task::find($task);
        $task_id = $task;
        if(empty($info)) {
            abort(404);
        ...
        return view('admin.admin_lvtasks', compact('info', 'task_id', 'inputValues', 'pages', 'pagesWithContent'));
    }

    public function AdminGetLiveViewTasks(Request $request){
    ...
    public function AdminTasksGetRadio(Request $request){
        // Fetch the field
    ...
    public function AdminTasksGetDown(Request $request){
        // Fetch the field
        $field = Task_fields::find($request->id);
    ...
    public function AdminTasksLiveReloading(Request $request){
        $id = $request->id;
    ...
    public function AdminTasksViewListTaskCheckingAutomation(Request $request){
...
//region change here
    ...
    public function AdminDeclineTask(Request $request){
        $id = $request->task;
        $rate = $request->rating;
...
//endregion
    public function AdminPrintTasks($task){
        $info = Task::find($task);
        $task_id = $task;
        if(empty($info)) {
            abort(404);
        ...
        return view('admin.admin_ptasks', compact('info', 'task_id', 'inputValues', 'pages', 'pagesWithContent'));
    }

    public function AdminGetPrintTasks(Request $request){
        $task_id = $request->task;
    ...
    public function AdminTasksPrintGetRadio(Request $request){
        // Fetch the field
        $field = Task_fields::find($request->id);
        $field->field_value = Task_inputs::where('field_id', $field->id)->value('value');
        // Decode the options
    ...
    public function AdminTasksPrintGetDown(Request $request){
        // Fetch the field
        $field = Task_fields::find($request->id);
    ...
    public function AdminTasksLivePrintReloading(Request $request){
        $id = $request->id;
    ...
    public function AdminDistributeTask(Request $request){
        $tasks = $request->task;
    ...
    public function AdminAcceptDistributeTask(Request $request){
        $dist = $request->dist;
    ...
    public function AdminDeclineDistributeTask(Request $request){
        $dist = $request->dist;
...
//region To fix in Accept All Distribute
    public function AdminAcceptAllDistributeTask(Request $request){
    ...
    public function AdminDeclineAllDistributeTask(Request $request){
...
//endregion
    ...
    public function AdminTasksViewNewTaskToLink(Request $request){
    ...
    public function AdminTasksCheckLinkTemp(Request $request){
        $task = $request->task;
    ...
    public function AdminTasksRemoveLinkTemp(Request $request){
        $task = $request->task;
        Link_tempo_group::where('task_id', $task)->where('adder_id', Auth::user()->id)->delete();
        return response()->json(['status' => 'success']);
    }

    public function AdminTasksAddMemberLinkTemp(Request $request){
        $task = $request->task;
        $user = $request->user;
    ...
    public function AdminTasksRemoveMemberLinkTemp(Request $request){
        $task = $request->task;
        $user = $request->user;
    ...
    public function AdminTasksLinkAndAssignTask(Request $request){
        $tasks = $request->task;
        $user = $request->user;
        $temp = $request->temp;
        $type = $request->type;
    ...
    public function AdminTasksGroupLinkAndAssignTask(Request $request){
        $tasks = $request->task;
        $temp = $request->temp;
        $due = $request->due;
    ...
    public function AdminTasksLinkAndAssignOngoingTask(Request $request){
        $task = $request->task;
        $link = $request->link;
    ...
    public function AdminTasksViewStatistic(Request $request){
        $task_id = $request->task;
    ...
    public function AdminTasksSetEmergencyUserStatus(Request $request){
        $task_id = $request->task;
    ...
    public function AdminTasksAcceptOvertimeRequest(Request $request){
        $task_id = $request->task;
    ...
    public function AdminTasksDeclineOvertimeRequest(Request $request){
        $task_id = $request->task;
    ...
    public function AdminTasksUnlinkTask(Request $request){
        $task_id = $request->task;
    ...
    public function AdminTasksArchiveDistributedTask(Request $request){
    ...
    public function AdminTasksArchiveCompletedTask(Request $request){
        $task = Task::find($request->task);
    ...
    public function AdminTasksRetrievetask(Request $request){
        $task = Task::find($request->task);
    ...
    public function AdminTasksDeletetask(Request $request){
        $task = Task::find($request->task);
    ...
    public function AdminChatSendTaskContactMessage(Request $request){
        $validator = Validator::make($request->all(), [
...
//region Calendar
    ...
    public function AdminCalendarViewTaskDate(){
        $events = [];
    ...
    public function AdminCalendarSaveEvent(Request $request){
        $validator = Validator::make($request->all(), [
    ...
    public function AdminCalendarViewPrivateEventDate(){
    ...
    public function AdminCalendarViewDepartmentEventDate(){
        $member = Member::where('user_id', Auth::user()->id)->first();
    ...
    public function AdminCalendarViewAnnouncementEventDate(){
    ...
    public function AdminCalendarRemoveEvent(Request $request){
...
//region department
    ...
    public function AdminDepartment(){
        ...
        return view('admin.admin_department', compact('dept'));
    }
    ...
    public function AdminGetUserDepartments(){
    ...
    public function AdminGetDepartmentHead(){
        $id = $_GET['id'];
    ...
    public function AdminGetDepartmentMember(){
        $id = $_GET['id'];
    ...
    public function AdminGetDepartmentVHead(){
        $id = $_GET['id'];
    ...
    public function AdminGetDepartmentVMember(){
        $id = $_GET['id'];
        $member = Member::where('department_id', $id)
        ->with('user')
        ->whereIn('role', ['Employee', 'Intern'])
    ...
    public function AdminGetDepartmentEDept(){
        $id = $_GET['id'];
    ...
    public function AdminGetDepartmentVUser(){
        $user = $_GET['user'];
        $dept = $_GET['dept'];
    ...
    public function AdminGetDepartmentMUser(){
        $user = $_GET['user'];
    ...
    public function AdminEditDepartment(Request $request){
        $validator = Validator::make($request->all(), [
            'name' => ['nullable', 'string'],
        ]);
    ...
    public function AdminDepartmentRDept(Request $request){
    ...
    public function AdminAssignDepartmentMember(Request $request){
        $request->validate([
    ...
    public function AdminRemoveDepartmentMember(Request $request){
...
//region Users
    ...
    public function AdminUsers(){
        ...
        return view('admin.admin_users', compact('account', 'internCount', 'employeeCount', 'observerCount', 'headCount', 'adminCount', 'total'));
    }
        ...
        <div class=\"row\">
            ...
            <div class=\"col-md-8 mb-3\">
                ...
                <div class=\"mb-3\">
                    ...
                    <input type=\"text\" name=\"name\" class=\"form-control\" id=\"name\" value=\"{$acc->name}\" required>
                </div>
                <div class=\"mb-3\">
                    <label for=\"email\" class=\"form-label\">Email Address</label>
                    <input type=\"email\" name=\"email\" class=\"form-control\" id=\"email\" value=\"{$acc->email}\" required>
                </div>
                <div class=\"mb-3\">
                    <label for=\"phone\" class=\"form-label\">Phone Number</label>
                    <input type=\"text\" name=\"phone\" class=\"form-control\" id=\"phone\" value=\"{$acc->phone}\" required>
                </div>
            </div>
        </div>";
    ...
    public function AdminUsersSIEdit(Request $request){
        $id = $request->id;
    ...
    public function AdminDeleteUser(Request $request){
        $check = Member::where('user_id', $request->user)->exists();
        if($check){
            return response()->json(['status' => 'cannotRemove']);
        }

        $user = User::find($request->user); // Find the user by its id

        if ($user) {
            $user->delete(); // Delete the department
            return response()->json(['status' => 'success']);
        }
    }
...
public function AdminChat(){
    ...
    return view('admin.admin_chat', compact('users', 'chatResult', 'rooms', 'roomsEnd'));
}

public function AdminChatSendContactMessage(Request $request){
    $validator = Validator::make($request->all(), [
        'message' => 'nullable|string',
        'attachments' => 'nullable|array|max:20', // Limit attachments to 20
        'attachments.*' =>  'file|mimes:jpg,jpeg,png,gif,webp,bmp,svg,ico,tiff,psd,ai,eps,pdf,doc,docx,txt,ppt,pptx,xls,xlsx,odt,ods,odp,rtf,csv,zip,rar,7z|max:10240', // 10MB max per file
...
public function AdminViewChats(Request $request){
...
public function AdminChatSendMessage(Request $request){
    $validator = Validator::make($request->all(), [
        'message' => 'nullable|string',
        'attachments' => 'nullable|array|max:20', // Limit attachments to 20
        'attachments.*' => 'file|mimes:jpg,jpeg,png,gif,webp,bmp,svg,ico,tiff,psd,ai,eps,pdf,doc,docx,txt,ppt,pptx,xls,xlsx,odt,ods,odp,rtf,csv,zip,rar,7z|max:10240', // 10MB max per file
...
public function AdminChatCheckWhoSeen(Request $request){
...
public function AdminCheckMessageAttachment(Request $request){
    $messageId = $request->message;
...
public function AdminChatRepliedUser(Request $request){
    $messageId = $request->message;
...
public function AdmincheckMessageReply(Request $request){
    $messageId = $request->message;
...
public function AdminChatGetTaskInfo(Request $request){
    $task_id = $request->task;
...
public function AdminGetEditMessage(Request $request){
    $messageId = $request->message;
    $message = Message::where('id', $messageId)->first();
...
public function AdminChatEditMessage(Request $request){
    $validator = Validator::make($request->all(), [
...
public function AdminViewEditMessage(Request $request){
    $messageId = $request->message;
...
public function AdminViewMessageContact(Request $request){
    $userId = Auth::id();
    $chats = ChatParticipant::where('chat_participants.user_id', $userId)
...
public function AdminChatSendForwardMessage(Request $request){
    $messageId = $request->message;
    $chatId = $request->chat;
...
public function AdminCheckWhoForward(Request $request){
    $messageId = $request->message;
    $message = Message::where('id', $messageId)->first();
...
public function AdminChatUnsendMessage(Request $request){
...
public function AdminChatPinMessage(Request $request){
    $messageId = $request->message;
    $chatId = $request->chat;
...
public function AdminChatUnpinMessage(Request $request){
    $messageId = $request->message;
    $chatId = $request->chat;
    $message = Message::where('id', $messageId)->whereNotIn('is_unsend', [1, 2])->first();
...
public function AdminChatReact(Request $request){
...
public function AdminViewPinnedMessage(Request $request){
    $chat_id = $request->chat;
...
public function AdminChatSetNickname(Request $request){
...
public function AdminChatSetMutedChat(Request $request){
    $chat_id = $request->chat_id;
...
public function AdminChatSearchMessageValue(Request $request) {
...
public function AdminChatSaveMeeting(Request $request) {
    try {
        $validator = Validator::make($request->all(), [
            'name' => 'required|string|max:255',
...
public function AdminChatRemoveMeeting(Request $request){
...
public function AdminChatCreateGroupMessage(Request $request){
...
public function AdminChatSetConvoImage(Request $request){
...
public function AdminChatUnsetConvoImage(Request $request){
    $chat_id = $request->chat;
...
public function AdminChatSetConvoName(Request $request){
...
public function AdminChatUnsetConvoName(Request $request){
...
public function AdminChatAddNewMemberGroup(Request $request) {
    $chat_id = $request->chat;
...
public function AdminChatToggleAsAdmin(Request $request){
    $chat = $request->chat;
    $user = $request->user;
    $type = $request->type;
...
public function AdminChatRemoveFromGroup(Request $request){
...
public function AdminChatLeaveConversation(Request $request){
    DB::transaction(function () use ($request) {
        $chat_id = $request->chat;
        $user_id = Auth::id();
...
public function AdminChatUnsetChatIsHere(){
    $user_id = Auth::id();
...
public function AdminChatSetChatIsHere(){
    $user_id = Auth::id();
...
public function AdminChatRemoveIsHere(){
    $user_id = Auth::id();
...
//region Log
    ...
    public function AdminSystemLog(){
        $logs = Log::orderBy('created_at', 'desc')->get();
        $manilaTimezone = 'Asia/Manila';
        foreach($logs as $log){
            $logTime = Carbon::parse($log->created_at)->setTimezone($manilaTimezone);
            if ($logTime->isToday()) {
                $log->formatted_time = $logTime->format('h:i A'); // e.g., "02:30 PM"
            } else {
                $log->formatted_time = $logTime->format('h:i A, M d'); // e.g., "02:30 PM, Aug 10"
            }

            $log->original_time = $log->created_at;
        }
