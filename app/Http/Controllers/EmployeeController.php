...
{
    public function EmployeeDashboardGetAllNotes(){
    ...
    public function EmployeeDashboardGetAllChats(){
        $userId = Auth::id();
    ...
    public function EmployeeDashboardGetAllFeedback(){
    ...
    public function EmployeeDashboardGetAllNotification(Request $request){
    ...
    public function EmployeeDashboardMarkAsReadedNotification(Request $request){
    ...
    public function EmployeeDashboardClearNotification(Request $request){
    ...
    public function EmployeeDashboardSetReviewedFeed(Request $request){
        $feed = $request->feed;
    ...
    public function EmployeeDashboardRemoveFeed(Request $request){
    ...
    public function EmployeeDashboard(){
        ...
        if (!$member) {
            ...
            return view('employee.index', compact('PerDepartment'));
        }
    ...
    public function EmployeeLogin(){
        if (Auth::check()) {
            return redirect('/employee/dashboard'); // Redirect if logged in
        }
    ...
    public function EmployeeProfile(){
        ...
        return view('employee.employee_profile', compact('profile'));
    }
    ...
    public function EmployeePersonalTable(){
        ...
        return view('employee.employee_personal_table', compact(
            'tasks', 'favorites', 'important', 'tag',
            'personalNotes', 'relatedTasks', 'notesCount', 'personalPrivateNotes'
        ));
    }

    public function EmployeePersonalTableSort(Request $request){
    ...
    public function EmployeePersonalTableMarkTask(Request $request){
    ...
    public function EmployeePersonalTableUpdateSort(Request $request){
        $user = Auth::id();
        $type = $request->input('type');
        if($type == 'task'){
    ...
    public function EmployeePersonalTableTaskFavorites(Request $request){
    ...
    public function EmployeePersonalTableTaskImportant(Request $request){
        $task_id = $request->task;
    ...
    public function EmployeePersonalTableTaskTag(Request $request){
        $task_id = $request->task;
    ...
    public function EmployeePersonalTableTaskNotes(Request $request){
        $user_id = Auth::id();
        $validator = Validator::make($request->all(), [
    ...
    public function EmployeePersonalTableTaskNotesRemove(Request $request){
        $task_id = $request->task;
    ...
    public function EmployeePersonalTableNotesRemove(Request $request){
        $note_id = $request->notes;
    ...
    public function EmployeePersonalTableEditNotes(Request $request){
        $validator = Validator::make($request->all(), [
            'title' => 'required|string|max:225',
    ...
    public function EmployeePersonalTableCreateNotes(Request $request){
        $user_id = Auth::id();
        $validator = Validator::make($request->all(), [
            'title' => 'required|string|max:225',
            'description' => 'nullable|string|max:225',
...
//region Task
    public function EmployeeTasks(){
        ...
        return view('employee.employee_tasks', compact('tasks', 'tocheck', 'complete'));
    }
    ...
    public function EmployeeTasksRequestOvertimeTask(Request $request){
        $task_id = $request->task;
    ...
    public function EmployeeEditTasks($task){
        $info = Task::find($task);
        ...
        return view('employee.employee_etasks', compact('info', 'pages', 'pagesWithContent', 'inputValues', 'pagesLinked', 'pagesLinkedWithContent', 'inputLinkedValues', 'linkedInfo'));
    }

    public function EmployeeEditSaveTasks(Request $request){
        ...
        if($request->from !== 'finish'){
            ...
            if ($request->ajax()) {
                return response()->json([
                    ...
                    'redirect' => route('employee.tasks') // Pass redirect URL
                ]);
            }
    ...
    public function EmployeeEditUserStatusCheckingTasks(Request $request){
        $statusMap = [
            'idle' => 'Idle',
            'not working' => 'Away',
            'working' => 'Active'
    ...
    public function EmployeeLiveViewTasks($task){
        $info = Task::find($task);
        $task_id = $task;
        if(empty($info)) {
            abort(404);
        ...
        return view('employee.employee_lvtasks', compact('info', 'task_id', 'inputValues', 'pages', 'pagesWithContent'));
    }

    public function EmployeeGetLiveViewTasks(Request $request){
        $task_id = $request->task;
    ...
    public function EmployeeTasksGetRadio(Request $request){
        // Fetch the field
    ...
    public function EmployeeTasksGetDown(Request $request){
        // Fetch the field
        $field = Task_fields::find($request->id);
    ...
    public function EmployeeTasksLiveReloading(Request $request){
        $id = $request->id;
    ...
    public function EmployeePrintTasks($task){
        $info = Task::find($task);
        $task_id = $task;
        if(empty($info)) {
            abort(404);
        ...
        return view('employee.employee_ptasks', compact('info', 'task_id', 'inputValues', 'pages', 'pagesWithContent'));
    }

    public function EmployeeGetPrintTasks(Request $request){
        $task_id = $request->task;
    ...
    public function EmployeeTasksPrintGetRadio(Request $request){
        // Fetch the field
        $field = Task_fields::find($request->id);
        $field->field_value = Task_inputs::where('field_id', $field->id)->value('value');
        // Decode the options
    ...
    public function EmployeeTasksPrintGetDown(Request $request){
        // Fetch the field
        $field = Task_fields::find($request->id);
    ...
    public function EmployeeTasksLivePrintReloading(Request $request){
        $id = $request->id;
...
//region Department
    public function EmployeeDepartment(){
        ...
        return view('employee.employee_department', compact('dept'));
    }
//endregion
...
public function EmployeeCalendarViewTaskDate(){
    $member = Member::where('user_id', Auth::user()->id)->first();
    $events = [];
    if($member){
        $soloTaskIds = Task_solo::where('user_id', Auth::id())->pluck('task_id')->toArray();
...
public function EmployeeCalendarSaveEvent(Request $request){
    $validator = Validator::make($request->all(), [
        'title' => 'required|string|max:225',
...
public function EmployeeCalendarViewPrivateEventDate(){
...
public function EmployeeCalendarViewDepartmentEventDate(){
    $member = Member::where('user_id', Auth::user()->id)->first();
...
public function EmployeeCalendarViewAnnouncementEventDate(){
...
public function EmployeeCalendarRemoveEvent(Request $request){
...
//region Chat
    public function EmployeeChat(){
        ...
        return view('employee.employee_chat', compact('users', 'chatResult', 'rooms', 'roomsEnd'));
    }

    public function EmployeeChatSendContactMessage(Request $request){
        $validator = Validator::make($request->all(), [
    ...
    public function EmployeeViewChats(Request $request){
    ...
    public function EmployeeChatSendMessage(Request $request){
        $validator = Validator::make($request->all(), [
            'message' => 'nullable|string',
            'attachments' => 'nullable|array|max:20', // Limit attachments to 20
            'attachments.*' => 'file|mimes:jpg,jpeg,png,gif,webp,bmp,svg,ico,tiff,psd,ai,eps,pdf,doc,docx,txt,ppt,pptx,xls,xlsx,odt,ods,odp,rtf,csv,zip,rar,7z|max:10240', // 10MB max per file
    ...
    public function EmployeeChatCheckWhoSeen(Request $request){
    ...
    public function EmployeeCheckMessageAttachment(Request $request){
        $messageId = $request->message;
    ...
    public function EmployeeChatRepliedUser(Request $request){
        $messageId = $request->message;
    ...
    public function EmployeecheckMessageReply(Request $request){
        $messageId = $request->message;
    ...
    public function EmployeeChatGetTaskInfo(Request $request){
        $task_id = $request->task;
    ...
    public function EmployeeGetEditMessage(Request $request){
        $messageId = $request->message;
        $message = Message::where('id', $messageId)->first();
    ...
    public function EmployeeChatEditMessage(Request $request){
        $validator = Validator::make($request->all(), [
    ...
    public function EmployeeViewEditMessage(Request $request){
        $messageId = $request->message;
    ...
    public function EmployeeViewMessageContact(Request $request){
        $userId = Auth::id();
        $chats = ChatParticipant::where('chat_participants.user_id', $userId)
    ...
    public function EmployeeChatSendForwardMessage(Request $request){
        $messageId = $request->message;
        $chatId = $request->chat;
    ...
    public function EmployeeCheckWhoForward(Request $request){
        $messageId = $request->message;
        $message = Message::where('id', $messageId)->first();
    ...
    public function EmployeeChatUnsendMessage(Request $request){
    ...
    public function EmployeeChatPinMessage(Request $request){
        $messageId = $request->message;
        $chatId = $request->chat;
    ...
    public function EmployeeChatUnpinMessage(Request $request){
        $messageId = $request->message;
        $chatId = $request->chat;
        $message = Message::where('id', $messageId)->whereNotIn('is_unsend', [1, 2])->first();
    ...
    public function EmployeeChatReact(Request $request){
    ...
    public function EmployeeViewPinnedMessage(Request $request){
        $chat_id = $request->chat;
    ...
    public function EmployeeChatSetNickname(Request $request){
    ...
    public function EmployeeChatSetMutedChat(Request $request){
        $chat_id = $request->chat_id;
    ...
    public function EmployeeChatSearchMessageValue(Request $request) {
    ...
    public function EmployeeChatSaveMeeting(Request $request) {
        try {
            $validator = Validator::make($request->all(), [
                'name' => 'required|string|max:255',
    ...
    public function EmployeeChatRemoveMeeting(Request $request){
    ...
    public function EmployeeChatCreateGroupMessage(Request $request){
    ...
    public function EmployeeChatSetConvoImage(Request $request){
    ...
    public function EmployeeChatUnsetConvoImage(Request $request){
        $chat_id = $request->chat;
    ...
    public function EmployeeChatSetConvoName(Request $request){
    ...
    public function EmployeeChatUnsetConvoName(Request $request){
    ...
    public function EmployeeChatAddNewMemberGroup(Request $request) {
        $chat_id = $request->chat;
    ...
    public function EmployeeChatToggleAsAdmin(Request $request){
        $chat = $request->chat;
        $user = $request->user;
        $type = $request->type;
    ...
    public function EmployeeChatRemoveFromGroup(Request $request){
    ...
    public function EmployeeChatLeaveConversation(Request $request){
        DB::transaction(function () use ($request) {
            $chat_id = $request->chat;
            $user_id = Auth::id();
    ...
    public function EmployeeChatUnsetChatIsHere(){
        $user_id = Auth::id();
    ...
    public function EmployeeChatSetChatIsHere(){
        $user_id = Auth::id();
    ...
    public function EmployeeChatRemoveIsHere(){
        $user_id = Auth::id();
