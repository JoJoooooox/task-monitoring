...
{
    private $DAILY_API_KEY = 'da2cdde2dd14d00fd8bf243fc4f775ec0c7baae82a2efe64f26daa93d8a55a24';
    private $DAILY_DOMAIN = 'tribo.daily.co';
    ...
    public function ObserverDashboardGetAllNotes(){
    ...
    public function ObserverDashboardGetAllChats(){
        $userId = Auth::id();
    ...
    public function ObserverDashboardGetAllFeedback(){
    ...
    public function ObserverDashboardGetAllNotification(Request $request){
    ...
    public function ObserverDashboardMarkAsReadedNotification(Request $request){
    ...
    public function ObserverDashboardClearNotification(Request $request){
    ...
    public function ObserverDashboardSetReviewedFeed(Request $request){
        $feed = $request->feed;
    ...
    public function ObserverDashboardRemoveFeed(Request $request){
...
//region Dashboard
    public function ObserverDashboard(){
        ...
        if (!$member) {
            ...
            return view('observer.index', compact('PerDepartment'));
        }

        // If `member` exists, retrieve all data
        $department = Department::where('id', $member->department_id)->get();
        $internCount = Member::where('role', 'intern')->where('department_id', $member->department_id)->count();
        $employeeCount = Member::where('role', 'employee')->where('department_id', $member->department_id)->count();
        ...
        $dist = Task::where('department_id', $member->department_id)->where('status', 'Distributed')->get();
        $linked = Task::where('department_id', $member->department_id)->where('status', 'Linked')->get();
        ...
        return view('observer.index', compact(
            'internCount',
            'employeeCount',
            'temp',
            'ongoing',
...
//endregion
    ...
    public function ObserverLogin(){
        if (Auth::check()) {
            return redirect('/manager/dashboard'); // Redirect if logged in
        }

        return view('observer.observer_login');
    }

    public function ObserverForgot(){
        if (Auth::check()) {
            return redirect('/manager/dashboard'); // Redirect if logged in
        }

        return view('observer.observer_forgot');
    }

    public function ObserverSendOtpEmail(Request $request){
    ...
    public function ObserverSendOtpPhone(Request $request){
        if(isset($request->otp)){
            $otp = $request->otp;
    ...
    public function ObserverSubmitNewPass(Request $request){
    ...
    public function ObserverLogout(Request $request){
    ...
    public function ObserverProfile(){
        ...
        return view('observer.observer_profile', compact('profile'));
    }
...
//region Task
    public function ObserverTasks() {
        $member = Member::where('user_id', Auth::user()->id)->first();

        // If no member is found, return the view with all variables set to null
        if (!$member) {
            return view('observer.observer_tasks', [
                'department' => null,
                'temp' => null,
                'ongoing' => null,
                'tocheck' => null,
        ...
        $department = Department::where('id', $member->department_id)->get();
        $dept_info = Department::where('id', $member->department_id)->first();
        $temp = Task_templates::where('department_id', $member->department_id)
        ->where('is_archived', 0)
        ...
        $ongoing = Task::where('department_id', $member->department_id)->whereIn('status', ['Ongoing', 'Overdue'])->where('is_archived', 0)->orderBy('created_at', 'desc')->get();
        $tocheck = Task::where('department_id', $member->department_id)->where('status', 'To Check')->where('is_archived', 0)->orderBy('created_at', 'desc')->get();
        $complete = Task::where('department_id', $member->department_id)->where('status', 'Completed')->where('is_archived', 0)->orderBy('created_at', 'desc')->get();
        $dist = Task::where('department_id', $member->department_id)->where('status', 'Distributed')->where('is_archived', 0)->orderBy('created_at', 'desc')->get();
        $linked = Task::where('department_id', $member->department_id)->where('status', 'Linked')->get();
        $distReq = Task_distribute_auto::where('to_department_id', $member->department_id)->where('status', 'Pending')->count();
        $distReqView = Task_distribute_auto::where('to_department_id', $member->department_id)->where('status', 'Pending')->get();
        $department_dist = Department::where('id', '!=', $member->department_id)->get();
        $ongoingLink = Task::where('department_id', $member->department_id)->whereIn('status', ['Ongoing', 'Overdue'])->whereNull('link_id')->where('is_archived', 0)->orderBy('created_at', 'desc')->get();
        $requestOvertime = Task::where('department_id', $member->department_id)
            ->whereIn('status', ['Ongoing', 'Overdue'])
            ->where('user_status', 'Request Overtime')
            ->with(['solo.user', 'group.user'])
            ->get();
        $archived = Task::where('department_id', $member->department_id)->where('is_archived', 1)->get();
        $archivedTemp = Task_templates::where('department_id', $member->department_id)->where('is_archived', 1)->get();

        return view('observer.observer_tasks', compact('member', 'department', 'temp', 'ongoing', 'tocheck', 'complete', 'dept_id', 'dist', 'distReq', 'distReqView', 'department_dist', 'ongoingLink', 'linked', 'dept_info', 'requestOvertime', 'archived', 'archivedTemp'));
    }

    public function reloadOngoingDiv(Request $request){
        // Retrieve all tasks from the database.
        $member = Member::where('user_id', Auth::user()->id)->first();
        $tasks = Task::whereIn('status', ['Ongoing', 'Overdue'])->where('department_id', $member->department_id)->where('is_archived', 0)->orderBy('created_at', 'desc')->get();
    ...
    public function reloadToCheckDiv(Request $request){
        $member = Member::where('user_id', Auth::user()->id)->first();
        $tasks = Task::where('status', 'To Check')->where('department_id', $member->department_id)->where('is_archived', 0)->orderBy('created_at', 'desc')->get();
    ...
    public function reloadCompleteDiv(Request $request){
        $member = Member::where('user_id', Auth::user()->id)->first();
        $tasks = Task::where('status', 'Completed')->where('department_id', $member->department_id)->where('is_archived', 0)->orderBy('created_at', 'desc')->get();
    ...
    public function reloadDistributeDiv(Request $request){
        $member = Member::where('user_id', Auth::user()->id)->first();
        $tasks = Task::where('status', 'Distributed')->where('department_id', $member->department_id)->where('is_archived', 0)->orderBy('created_at', 'desc')->get();
    ...
    public function reloadDistributeReqDiv(Request $request){
        $member = Member::where('user_id', Auth::user()->id)->first();
        $tasks = Task_distribute_auto::where('to_department_id', $member->department_id)->where('status', 'Pending')->get();
    ...
    public function reloadOvertimeReqDiv(Request $request){
        ...
        $tasks = Task::where('department_id', $member->department_id)
        ->whereIn('status', ['Ongoing', 'Overdue'])
        ->where('user_status', 'Request Overtime')
        ->with(['solo.user', 'group.user'])
        ->get();
    ...
    public function ObserverTasksEditTemplate(){
    ...
    public function ObserverTasksEditInfoTemplate(Request $request){
        $id = $request->id;
    ...
    public function ObserverTasksAddPage(Request $request){
    ...
    public function ObserverTasksSavePageTitle(Request $request){
        $validator = Validator::make($request->all(), [
    ...
    public function ObserverTasksSaveTaskInfo(Request $request){
        $validator = Validator::make($request->all(), [
    ...
    public function ObserverTasksRemovePage(){
    ...
    public function ObserverTasksAddField(){
    ...
    public function ObserverTasksSaveFieldInput(Request $request){
        $validator = Validator::make($request->all(), [
    ...
    public function ObserverTasksGetOptionRadio(Request $request){
        // Fetch the field
    ...
    public function ObserverTasksGetOptionDown(Request $request){
        // Fetch the field
        $field = Task_templates_fields::find($request->id);
    ...
    public function ObserverTasksRemoveFieldRow(Request $request){
        $field = Task_templates_fields::find($request->id);
        $field->delete();
    ...
    public function ObserverTasksEditFieldTask(Request $request){
        $id = $request->content;
    ...
    public function ObserverTasksChangeStepperTask(Request $request){
        $temp = Task_templates::find($request->id);
    ...
    public function ObserverTasksViewDistributeTaskDepartment(Request $request){
        $temp = Task_templates::find($request->id);
    ...
    public function ObserverTasksCheckDistributeTaskDepartment(Request $request){
        $temp = $request->temp;
        $dept = $request->dept;
    ...
    public function ObserverTasksSubmitDistributeTaskDepartment(Request $request){
        $temp = $request->temp;
        $dept = $request->dept;
    ...
    public function ObserverTasksViewListSoloAssignTask(Request $request){
        $id = $request->dept;
    ...
    public function ObserverTasksSubmitAssignSoloTask(Request $request){
        $validator = Validator::make($request->all(), [
            'due' => ['required'],
        ]);
        ...
        if($existSolo){
            ...
            $existTask = Task::where('id', $task_id)->where('status', 'Ongoing');
        ...
        if($profile->id != Auth::id()){
            ...
            if ($profile->role == 'observer') {
                $taskUrl = 'https://tribo.uno/manager/etasks/'.$task->id;
    ...
    public function ObserverTasksCreate(Request $request){
        $validator = Validator::make($request->all(), [
            'title' => ['required', 'string'],
    ...
    public function ObserverTasksViewListGroupAssignTask(Request $request){
    ...
    public function ObserverTasksAddTemporaryAssignGroupTask(Request $request){
    ...
    public function ObserverTasksRemoveTemporaryAssignGroupTask(Request $request){
        Task_tempo_group::where('user_id', $request->user)->where('template_id', $request->temp)->where('adder_id', Auth::user()->id)->delete();
        return response()->json(['status' => 'success']);
    }

    public function ObserverTasksSubmitAssignGroupTask(Request $request){
        $validator = Validator::make($request->all(), [
            'due' => ['required'],
        ]);
        ...
        if ($existMembers->isEmpty()) {
            return response()->json([
                'status' => 'errorTask',
                'message' => "No users found in Link_tempo_group for this task."
            ]);
        }
    ...
    public function ObserverTasksViewListSoloAutomationAssignTask(Request $request){
        $id = $request->dept;

        $members = Member::where('department_id', $id)->get();
        $tempo = Task_solo_auto::where('template_id', $request->temp)->where('adder_id', Auth::user()->id)->get();
        $tempoUserIds = $tempo->pluck('user_id')->toArray();
        ...
        // Fetch Selected Users
        $selected = Task_solo_auto::where('template_id', $request->temp)
            ->where('adder_id', Auth::user()->id)
            ->get();

        $selectedUser = $selected->map(function ($select) {
            return ['profile' => User::find($select->user_id), 'autoSolo' => $select];
        });

        return response()->json(['users' => $users, 'selectedUser' => $selectedUser]);
    }

    public function ObserverTasksSubmitListSoloAutomationAssignTask(Request $request){
        $validator = Validator::make($request->all(), [
            'type' => ['required'],
            'start_day' => $request->type !== 'week' ? ['required'] : [],
            'end_day' => $request->type !== 'week' ? ['required'] : [],
            'only_day' => $request->type === 'week' ? ['required']  : [],
        ...
        if (!empty($request->start_time) && !empty($request->end_time)) {
            ...
            if ($startTime->greaterThanOrEqualTo($endTime)) {
                return response()->json(['status' => 'timeGreater']);
            }
        }

        $auto_Solo = new Task_solo_auto();
        $auto_Solo->user_id = $request->user;
        $auto_Solo->template_id = $request->temp;
        $auto_Solo->adder_id = Auth::user()->id;
        $auto_Solo->type = $request->type;
        $auto_Solo->due = $request->due;
        $auto_Solo->start_time = $request->start_time;
        $auto_Solo->end_time = $request->end_time;
        if($request->type == 'week'){
            $auto_Solo->start_day = $request->only_day;
            $auto_Solo->end_day = $request->only_day;
        } else {
            $auto_Solo->start_day = $request->start_day;
            $auto_Solo->end_day = $request->end_day;
        }
        $auto_Solo->save();
        ...
        $log = new Log();
        $log->name = Auth::user()->name;
        $log->action = "Assign User in Automation Solo Task: {$template->title} User: {$users->name} ID: {$request->user}";
        $log->description = date('Y-m-d');
        $log->save();
    ...
    public function ObserverTasksRemoveTemporaryAutomationAssignSoloTask(Request $request){
        Task_solo_auto::where('user_id', $request->user)->where('template_id', $request->temp)->where('adder_id', Auth::user()->id)->delete();
        ...
        $log = new Log();
        $log->name = Auth::user()->name;
        $log->action = "Remove User Assign in Automation Solo Task: {$template->title} User: {$users->name} ID: {$request->user}";
        $log->description = date('Y-m-d');
        $log->save();
    ...
    public function ObserverTasksViewListGroupAutomationAssignTask(Request $request){
        if (!isset($request->cont)) {
            $continue = Task_group_tempo_member_auto::where('template_id', $request->temp)
                ->where('adder_id', Auth::user()->id)
                ->get();
            ...
            // If cont == 0, delete previous selections
            Task_group_tempo_member_auto::where('template_id', $request->temp)
                ->where('adder_id', Auth::user()->id)
                ->delete();
        }
        ...
        $members = Member::where('department_id', $id)->get();
        $tempo = Task_group_tempo_member_auto::where('template_id', $request->temp)->get();
        $tempoUserIds = $tempo->pluck('user_id')->toArray();
        ...
        // Fetch Selected Users
        $selected = Task_group_auto::where('template_id', $request->temp)
            ->where('adder_id', Auth::user()->id)
            ->get();

        $selectedUser = $selected->map(function ($select) {
            return ['autoGroup' => $select];
        });

        $selectedTempo = Task_group_tempo_member_auto::where('template_id', $request->temp)
            ->where('adder_id', Auth::user()->id)
            ->get();

        $selectedUserToGroup = $selectedTempo->map(function ($select) {
            return ['profile' => User::find($select->user_id)];
        });

        return response()->json(['users' => $users, 'selectedUser' => $selectedUser, 'selectedUserToGroup' => $selectedUserToGroup]);
    }

    public function ObserverTasksSubmitListGroupAutomationAssignTask(Request $request){
        $tempo = new Task_group_tempo_member_auto();
        $tempo->user_id = $request->user;
        $tempo->template_id = $request->temp;
        $tempo->adder_id = Auth::user()->id;
        $tempo->save();
    ...
    public function ObserverTasksRemoveTemporaryAutomationAssignGroupTask(Request $request){
        Task_group_tempo_member_auto::where('user_id', $request->user)->where('template_id', $request->temp)->where('adder_id', Auth::user()->id)->delete();
        return response()->json(['status' => 'success']);
    }

    public function ObserverTasksRemoveTemporaryAutomationAssignGroupListTask(Request $request){
        Task_group_auto::where('id', $request->group)->where('template_id', $request->temp)->where('adder_id', Auth::user()->id)->delete();
        Task_group_member_auto::where('group_id', $request->group)->where('template_id', $request->temp)->where('adder_id', Auth::user()->id)->delete();

        $template = Task_templates::find($request->temp);

        $log = new Log();
        $log->name = Auth::user()->name;
        $log->action = "Remove Group Assign in Automation Group Task: {$template->title} Group ID: {$request->group}";
        $log->description = date('Y-m-d');
        $log->save();
    ...
    public function ObserverTasksSubmitListGroupMemberAutomationAssignTask(Request $request){
        $validator = Validator::make($request->all(), [
            'type' => ['required'],
            'start_day' => $request->type !== 'week' ? ['required'] : [],
            'end_day' => $request->type !== 'week' ? ['required'] : [],
        ...
        $list_member = Task_group_tempo_member_auto::where('template_id', $request->temp)
        ->where('adder_id', Auth::user()->id)
        ->get();

        $list_member_count = Task_group_tempo_member_auto::where('template_id', $request->temp)
        ->where('adder_id', Auth::user()->id)
        ->count();
        if($list_member_count <= 1){
            return response()->json(['status' => 'onlyOne']);
        }

        $auto_Group = new Task_group_auto();
        $auto_Group->user_id = 0;
        $auto_Group->template_id = $request->temp;
        $auto_Group->due = $request->due;
        $auto_Group->adder_id = Auth::user()->id;
        $auto_Group->type = $request->type;
        if($request->type == 'week'){
            $auto_Group->start_day = $request->only_day;
            $auto_Group->end_day = $request->only_day;
        } else {
            $auto_Group->start_day = $request->start_day;
            $auto_Group->end_day = $request->end_day;
        }
        $auto_Group->start_time = $request->start_time;
        $auto_Group->end_time = $request->end_time;
        $auto_Group->save();

        $new_id = $auto_Group->id;
        foreach($list_member as $member){
            $auto_Member = new Task_group_member_auto();
            $auto_Member->group_id = $new_id;
            $auto_Member->template_id = $request->temp;
            $auto_Member->user_id = $member->user_id;
            $auto_Member->adder_id = Auth::user()->id;
            $auto_Member->save();
        }
        ...
        $log = new Log();
        $log->name = Auth::user()->name;
        $log->action = "Assign New Group in Automation Group Task: {$template->title}";
        $log->description = date('Y-m-d');
        $log->save();
    ...
    public function ObserverTasksArchiveTemplate(Request $request){
        $template = Task_templates::find($request->temp);
    ...
    public function ObserverTasksRetrievetemp(Request $request){
    ...
    public function ObserverTasksDeletetemp(Request $request){
        $template = Task_templates::find($request->temp);
    ...
    public function ObserverEditTasks($task){
        $info = Task::find($task);
        ...
        return view('observer.observer_etasks', compact('info', 'pages', 'pagesWithContent', 'inputValues', 'pagesLinked', 'pagesLinkedWithContent', 'inputLinkedValues', 'linkedInfo'));
    }

    public function ObserverEditSaveTasks(Request $request){
        ...
        if($request->from !== 'finish'){
            ...
            if ($request->ajax()) {
                return response()->json([
                    ...
                    'redirect' => route('observer.tasks') // Pass redirect URL
                ]);
            }

            session()->flash('success', 'Task marked as "To Check"');

            return redirect()->route('observer.tasks');
        }
    }

    public function ObserverEditUserStatusCheckingTasks(Request $request){
        $statusMap = [
            'idle' => 'Idle',
            'not working' => 'Away',
            'working' => 'Active'
    ...
    public function ObserverLiveViewTasks($task){
        $info = Task::find($task);
        $task_id = $task;
        if(empty($info)) {
            abort(404);
        ...
        return view('observer.observer_lvtasks', compact('info', 'task_id', 'inputValues', 'pages', 'pagesWithContent'));
    }

    public function ObserverGetLiveViewTasks(Request $request){
    ...
    public function ObserverTasksGetRadio(Request $request){
        // Fetch the field
    ...
    public function ObserverTasksGetDown(Request $request){
        // Fetch the field
        $field = Task_fields::find($request->id);
    ...
    public function ObserverTasksLiveReloading(Request $request){
        $id = $request->id;
    ...
    public function ObserverTasksViewListTaskCheckingAutomation(Request $request){
        $id = $request->dept;

        $templates = Task_templates::where('department_id', $id)->get();
        $checker = Task_check_auto::where('department_id', $id)->get();
        ...
        // Fetch Selected Users
        $selected = Task_check_auto::where('department_id', $id)->get();

        return response()->json(['temp' => $temp, 'selected' => $selected]);
    }

    public function ObserverSubmitAutomationToCheckTask(Request $request){
        $temp = $request->temp;
        $dept = $request->dept;

        $template = Task_templates::where('id', $temp)->first();
        $submit = new Task_check_auto();
        $submit->template_id = $temp;
        $submit->department_id = $dept;
        $submit->adder_id = Auth::user()->id;
        $submit->title = $template->title;
        $submit->save();

        $log = new Log();
        $log->name = Auth::user()->name;
        $log->action = "Set task to automation checking: {$template->title} User: ".Auth::user()->name." ID: ".Auth::user()->id;
        $log->description = date('Y-m-d');
        $log->save();
    ...
    public function ObserverRemoveAutomationToCheckTask(Request $request){
        Task_check_auto::where('department_id', $request->dept)->where('template_id', $request->temp)->delete();
        $template = Task_templates::find($request->temp);

        $log = new Log();
        $log->name = Auth::user()->name;
        $log->action = "Remove task checking automation: {$template->title} User: ".Auth::user()->name." ID: ".Auth::user()->id;
        $log->description = date('Y-m-d');
        $log->save();
...
//region change here
    ...
    public function ObserverApproveTask(Request $request){
        $id = $request->task;
        $task = Task::find($id);
        ...
        if($task->type == 'Solo'){
            ...
            if($profile->id != Auth::id()){
                $taskUrl = '';
                if ($profile->role == 'observer') {
                    $taskUrl = 'https://tribo.uno/manager/lvtasks/'.$task->id;
                } elseif ($profile->role == 'employee') {
    ...
    public function ObserverDeclineTask(Request $request){
        $id = $request->task;
        $rate = $request->rating;
...
//endregion
    public function ObserverPrintTasks($task){
        $info = Task::find($task);
        $task_id = $task;
        if(empty($info)) {
            abort(404);
        ...
        return view('observer.observer_ptasks', compact('info', 'task_id', 'inputValues', 'pages', 'pagesWithContent'));
    }

    public function ObserverGetPrintTasks(Request $request){
        $task_id = $request->task;
    ...
    public function ObserverTasksPrintGetRadio(Request $request){
        // Fetch the field
        $field = Task_fields::find($request->id);
        $field->field_value = Task_inputs::where('field_id', $field->id)->value('value');
        // Decode the options
    ...
    public function ObserverTasksPrintGetDown(Request $request){
        // Fetch the field
        $field = Task_fields::find($request->id);
    ...
    public function ObserverTasksLivePrintReloading(Request $request){
        $id = $request->id;
    ...
    public function ObserverTasksDistributionAutomation(Request $request){
        $id = $request->dept;

        $templates = Task_templates::where('department_id', $id)->get();

        // Fetch Selected Users
        $selected = Task_template_distribute_auto::where('department_id', $id)->get();
        $department = Department::where('id', '!=', $id)->get();

        return response()->json(['temp' => $templates, 'selected' => $selected, 'department' => $department]);
    }

    public function ObserverSubmitAutomationDistributeTask(Request $request){
        $temp = $request->temp;
        $dept = $request->dept;
        $to = $request->department_id;

        $checkFirst = Task_template_distribute_auto::where('template_id', $temp)
        ->where('department_id', $dept)
        ->where('to_department_id', $to)
        ->exists();
        ...
        $template = Task_templates::where('id', $temp)->first();
        $department = Department::find($to);
        $submit = new Task_template_distribute_auto();
        $submit->template_id = $temp;
        $submit->department_id = $dept;
        $submit->to_department_id = $to;
        $submit->to_department_name = $department->name;
        $submit->adder_id = Auth::user()->id;
        $submit->title = $template->title;
        $submit->save();
        ...
        $log = new Log();
        $log->name = Auth::user()->name;
        $log->action = "Set task to automation distribution: {$template->title} User: ".Auth::user()->name." ID: ".Auth::user()->id;
        $log->description = date('Y-m-d');
        $log->save();
    ...
    public function ObserverRemoveAutomationDistributeTask(Request $request){
        Task_template_distribute_auto::where('department_id', $request->dept)->where('template_id', $request->temp)->delete();
        $template = Task_templates::find($request->temp);

        $log = new Log();
        $log->name = Auth::user()->name;
        $log->action = "Remove task distribution automation: {$template->title} User: ".Auth::user()->name." ID: ".Auth::user()->id;
        $log->description = date('Y-m-d');
        $log->save();
    ...
    public function ObserverDistributeTask(Request $request){
        $tasks = $request->task;
        $to = $request->department_id;
        $cont = $request->cont;
    ...
    public function ObserverAcceptDistributeTask(Request $request){
        $dist = $request->dist;
    ...
    public function ObserverDeclineDistributeTask(Request $request){
        $dist = $request->dist;
    ...
    public function ObserverAcceptAllDistributeTask(Request $request){
        $member = Member::where('user_id', Auth::user()->id)->first();

        $distributes = Task_distribute_auto::where('to_department_id', $member->department_id)->where('status', 'Pending')->get();
    ...
    public function ObserverDeclineAllDistributeTask(Request $request){
        $member = Member::where('user_id', Auth::user()->id)->first();
    ...
    public function ObserverTasksAcceptDistributionAutomation(Request $request){
        $id = $request->dept;

        $accepted = Task_distribute_auto::selectRaw('template_id, department_id, COUNT(*) as count')
        ->where('to_department_id', $id)
        ->where('status', 'Accepted')
        ->groupBy('template_id', 'department_id')
        ->get();

        $selects = Task_distribute_auto_accept::where('my_department_id', $id)->get();
        $selectedIds = $selects->map(fn ($sel) => $sel->template_id . '-' . $sel->department_id)->toArray();
        $selected = $selects->map(function ($select) {
            $department = Department::find($select->department_id);
            $task = Task_templates::find($select->template_id);
            return [
                'select' => $select,
        ...
        $accepts = $accepted->map(function ($accept) {
            $department = Department::find($accept->department_id);
            $task = Task_templates::find($accept->template_id);
            return [
                'accepted' => $accept,
                'department' => $department,
                'task_title' => $task,
                'unique_key' => $accept->template_id . '-' . $accept->department_id
            ];
        })
        ->reject(fn ($accept) => in_array($accept['unique_key'], $selectedIds)) // Remove selected items
        ->values();
        ...
        return response()->json(['accepts' => $accepts, 'selected' => $selected, 'department' => $department]);
    }

    public function ObserverTasksSubmitAcceptDistributionAutomation(Request $request){
        $dept = $request->dept;
        $todept = $request->todept;
        $temp = $request->temp;

        $set = new Task_distribute_auto_accept();
        $set->template_id = $temp;
        $set->department_id = $todept;
        $set->my_department_id = $dept;
        $set->adder_id = Auth::user()->id;
        $set->save();

        $distribute = Task_templates::find($temp);
        $log = new Log();
        $log->name = Auth::user()->name;
        $log->action = "Set Automation Accept Distributed Task: {$distribute->title} From: Department ID {$dept} To: Department ID {$distribute->department_id}";
        $log->description = date('Y-m-d');
        $log->save();
        return response()->json(['status' => 'success']);
    }

    public function ObserverTasksRemoveAcceptDistributionAutomation(Request $request){
        $dept = $request->dept;
        $todept = $request->todept;
        $temp = $request->temp;

        Task_distribute_auto_accept::where('template_id', $temp)->where('department_id', $todept)->where('my_department_id', $dept)->delete();

        $distribute = Task_templates::find($temp);
        $log = new Log();
        $log->name = Auth::user()->name;
        $log->action = "Remove Automation Accept Distributed Task: {$distribute->title} From: Department ID {$dept} To: Department ID {$distribute->department_id}";
        $log->description = date('Y-m-d');
        $log->save();
    ...
    public function ObserverTasksViewNewTaskToLink(Request $request){
        $link = Task::find($request->task);

        $members = Member::where('user_id', Auth::user()->id)->first();
        $templates = Task_templates::where('department_id', $members->department_id)->get();

        $getMembers = Member::where('department_id', $members->department_id)->get();

        $soloUsers = $getMembers->map(function ($member) use ($members) {
            $count_solo = Task_solo::where('user_id', $member->user_id)->count();
            $count_group = Task_group::where('user_id', $member->user_id)->count();
            $department = Department::find($members->department_id);
            $user = User::find($member->user_id);
            $count = $count_solo + $count_group;
            return [
                'profile' => $user,
        ...
        $groupUsers = $getMembers->map(function ($member) use ($members) {
            $count_solo = Task_solo::where('user_id', $member->user_id)->count();
            $count_group = Task_group::where('user_id', $member->user_id)->count();
            $department = Department::find( $members->department_id);
            $user = User::find($member->user_id);
    ...
    public function ObserverTasksCheckLinkTemp(Request $request){
        $task = $request->task;
    ...
    public function ObserverTasksRemoveLinkTemp(Request $request){
        $task = $request->task;
        Link_tempo_group::where('task_id', $task)->where('adder_id', Auth::user()->id)->delete();
        return response()->json(['status' => 'success']);
    }

    public function ObserverTasksAddMemberLinkTemp(Request $request){
        $task = $request->task;
        $user = $request->user;
    ...
    public function ObserverTasksRemoveMemberLinkTemp(Request $request){
        $task = $request->task;
        $user = $request->user;
    ...
    public function ObserverTasksLinkAndAssignTask(Request $request){
        $tasks = $request->task;
        $user = $request->user;
        $temp = $request->temp;
        $type = $request->type;
        ...
        if($type == 'Solo'){
            Link_tempo_group::where('task_id', $tasks)->where('adder_id', Auth::user()->id)->delete();
        }
    ...
    public function ObserverTasksGroupLinkAndAssignTask(Request $request){
        $tasks = $request->task;
        $temp = $request->temp;
        $due = $request->due;
        $department = Member::where('user_id', Auth::user()->id)->first();
        ...
        if(!$request->has('reassign')){
            foreach($existMembers as $eMember){
                ...
                if($existGroup->isNotEmpty()){
                    $existTasks = Task::where('status', 'Ongoing')
                                ->where('status', 'Ongoing')
                                ->whereNotNull('link_id')
                                ->where('type', 'Group')
                                ->get();
    ...
    public function ObserverTasksLinkAndAssignOngoingTask(Request $request){
        $task = $request->task;
        $link = $request->link;
        ...
        if ($submit->type === 'Group') {
            ...
            foreach ($group as $gnotif) {
                $notif = new Notification();
                $notif->user_id = $gnotif->user_id;
                $notif->message = 'Observer Linked Task: ' . $change->title . ' ID: ' . $link . ' To Your Task: ' . $submit->title;
                $notif->type = 'info';
                $notif->save();
            }
            ...
            if ($solo) { // Ensure $solo exists before using it
                ...
                $notif->message = 'Observer: ' . Auth::user()->name . ' Linked Task: ' . $change->title . ' ID: ' . $link . ' To Your Task: ' . $submit->title;
                $notif->type = 'info';
                $notif->save();
            }
        }
    ...
    public function ObserverTasksViewLinkAuto(Request $request){
        $id = $request->dept;

        //region Solo  Task
        $membersSolo = Member::where('department_id', $id)->get();
        $tempoSolo = Link_solo_auto::where('department_id', $id)->get();
        $tempoSoloUserIds = $tempoSolo->pluck('user_id')->toArray();
        $templateSolo = Task_templates::where('department_id', $id)->where('type', 'Solo')->get();
        ...
        $usersSolo = $membersSolo->map(function ($member) use ($request) {
            $count_solo = Task_solo::where('user_id', $member->user_id)->count();
            $count_group = Task_group::where('user_id', $member->user_id)->count();
            $department = Department::find($request->dept);
            $user = User::find($member->user_id);
        ...
        ->reject(function ($user) use ($tempoSoloUserIds) {
            // Reject users whose id is in $tempoSoloUserIds
            return in_array($user['profile']->id, $tempoSoloUserIds);
        })
        ->values();

            // Fetch Selected Users
        $selectedSolo = Link_solo_auto::where('department_id', $id)
            ->get();

        $selectedUserSolo = $selectedSolo->map(function ($select) {
            return ['profile' => User::find($select->user_id), 'autoSolo' => $select];
        });
        ...
        $membersGroup = Member::where('department_id', $id)->get();
        $tempoGroup = Link_tempo_group_auto::where('department_id', $id)->get();
        $tempoGroupUserIds = $tempoGroup->pluck('user_id')->toArray();
        $templateGroup = Task_templates::where('department_id', $id)->where('type', 'Group')->get();

        $usersGroup = $membersGroup->map(function ($member) use ($request) {
            $count_solo = Task_solo::where('user_id', $member->user_id)->count();
            $count_group = Task_group::where('user_id', $member->user_id)->count();
            $department = Department::find($request->dept);
            $user = User::find($member->user_id);
        ...
        ->reject(function ($user) use ($tempoGroupUserIds) {
            // Reject users whose id is in $tempoGroupUserIds
            return in_array($user['profile']->id, $tempoGroupUserIds);
        })
        ->values();

        // Fetch Selected Users
        $selectedGroup = Link_group_auto::where('department_id', $id)
            ->get();

        $selectedGroupUser = $selectedGroup->map(function ($select) {
            return ['autoGroup' => $select];
        });

        $selectedGroupTempo = Link_tempo_group_auto::where('department_id', $id)
            ->where('adder_id', Auth::user()->id)
            ->get();

        $selectedUserToGroup = $selectedGroupTempo->map(function ($select) {
            return ['profile' => User::find($select->user_id)];
        });
        ...
        return response()->json(['usersSolo' => $usersSolo, 'selectedUserSolo' => $selectedUserSolo, 'templateSolo' => $templateSolo, 'linkTask' => $accepts, 'templateGroup' => $templateGroup, 'usersGroup' => $usersGroup, 'selectedGroupUser' => $selectedGroupUser, 'selectedUserToGroup' => $selectedUserToGroup]);
    }

    public function ObserverTasksGroupCheckTempoMemberLink(Request $request){
        if (!isset($request->cont)) {
            $continue = Link_tempo_group_auto::where('department_id', $request->dept)
                ->where('adder_id', Auth::user()->id)
                ->get();
        ...
        } elseif (isset($request->cont) && $request->cont == 0) {
            // If cont == 0, delete previous selections
            Link_tempo_group_auto::where('department_id', $request->dept)
                ->where('adder_id', Auth::user()->id)
                ->delete();
    ...
    public function ObserverTasksSetSoloLinkAuto(Request $request){
        $validator = Validator::make($request->all(), [
        ...
        if ($startTime->greaterThanOrEqualTo($endTime)) {
            return response()->json(['status' => 'error', 'message' => 'Start time should be greater than end time']);
        }

        $user = User::find($user);
        $template = Task_templates::find($request->template_id);
        $linked = Task_templates::find($request->link_id);

        if (!$user || !$template || !$linked) {
            return response()->json([
                'status' => 'error',
                'message' => 'Invalid User, Template, or Linked Task'
            ]);
        }

        $auto_Solo = new Link_solo_auto();
        $auto_Solo->fill([
            'user_id' => $user->id,
            ...
            'start_day' => $request->type === 'week' ? $request->only_day : $request->start_day,
            'end_day' => $request->type === 'week' ? $request->only_day : $request->end_day,
        ]);
        $auto_Solo->save();

        Log::create([
            'name' => Auth::user()->name,
            'action' => "Assigned User in Automation Solo Link Task: {$template->title} User: {$user->name} (ID: {$user->id}) to Linked Task: {$linked->title}",
    ...
    public function ObserverTasksRemoveSoloLinkAuto(Request $request){
        $user = $request->user;
        $dept = $request->dept;

        $checkFirst = Link_solo_auto::where('user_id', $user)->where('department_id', $dept)->exists();
        if(!$checkFirst){
            return response()->json([
                'status' => 'error',
                'message' => "Oops! This user is not existing anymore"
            ]);
        }

        Link_solo_auto::where('user_id', $user)->where('department_id', $dept)->delete();

        $users = User::find($user);
        Log::create([
            'name' => Auth::user()->name,
            'action' => "Assigned User in Automation Solo Link Task Removed User: {$users->name} (ID: {$users->id})",
            'description' => now()->toDateString()
        ]);
        return response()->json(['status' => 'success']);
    }

    public function ObserverTasksAddTempoGroupLinkAuto(Request $request){
        $user = $request->user;
        $dept = $request->dept;

        $checkOtherMember = Link_member_group_auto::where('user_id', $user)->where('department_id', $dept)->exists();
        if($checkOtherMember){
            return response()->json([
                'status' => 'error',
                'message' => 'This user is already set in automation. Remove it first before adding to a new automation group.'
            ]);
        }

        Link_tempo_group_auto::create([
            'department_id' => $dept,
            'user_id' => $user,
            'adder_id' => Auth::id(),
        ]);
    ...
    public function ObserverTasksRemoveTempoGroupLinkAuto(Request $request){
        $user = $request->user;
        $dept = $request->dept;

        Link_tempo_group_auto::where('user_id', $user)->where('department_id', $dept)->delete();
    ...
    public function ObserverTasksSetGroupLinkAuto(Request $request){
        $validator = Validator::make($request->all(), [
            'template_id' => ['required'],
            'link_id' => ['required'],
            'type' => ['required'],
        ...
        $list_member = Link_tempo_group_auto::where('department_id', $dept)
        ->where('adder_id', Auth::user()->id)
        ->get();

        if($list_member->count() <= 1){
            return response()->json([
                'status' => 'error',
                'message' => 'You can\'t submit this if there\'s only one member selected'
            ]);
        }
        ...
        if (!$template || !$linked) {
            return response()->json([
                'status' => 'error',
                'message' => 'Invalid Template, or Linked Task'
            ]);
        }

        $auto_Group = new Link_group_auto();
        $auto_Group->fill([
            'user_id' => 0,
            'template_id' => $template->id,
            'link_id' => $linked->id,
        ...
        $templateTitle = $template->title ?? 'Unknown Task';
        Log::create([
            'name' => Auth::user()->name,
            'action' => "Assign New Group in Automation Group Task: {$templateTitle} Linked Task: {$linked->title}",
            'description' => now()->format('Y-m-d'),
        ]);

        Link_tempo_group_auto::where('department_id', $dept)
                ->where('adder_id', Auth::user()->id)
                ->delete();
    ...
    public function ObserverTasksRemoveGroupLinkAuto(Request $request){
        $group = $request->group;
        $dept = $request->dept;

        $template = Task_templates::find($request->temp);
        $linked = Task_templates::find($request->link);
        if (!$template || !$linked) {
            return response()->json([
                'status' => 'error',
                'message' => 'Invalid Template, or Linked Task'
        ...
        $checkFirst = Link_group_auto::where('id', $group)->exists();
        if(!$checkFirst){
            return response()->json(['status' => 'error', 'message' => 'This group is not existing']);
        }

        Link_group_auto::where('id', $group)->delete();
        Link_member_group_auto::where('group_id', $group)->delete();

        Log::create([
            'name' => Auth::user()->name,
            'action' => "Assign New Group in Automation Group Task: {$template->title} Linked Task: {$linked->title}",
            'description' => now()->format('Y-m-d'),
        ]);
    ...
    public function ObserverTasksViewStatistic(Request $request){
        $task_id = $request->task;
    ...
    public function ObserverTasksSetEmergencyUserStatus(Request $request){
        $task_id = $request->task;
        ...
        if($task->type === 'Solo'){
            ...
            $notif = new Notification();
            $notif->user_id = $solo->user_id;
            $notif->message = 'Observer: ' . Auth::user()->name . ' Set Your Task: ' . $task->title . ' To Emergency';
            $notif->type = 'info';
            $notif->save();
            ...
            foreach($group as $member){
                ...
                $notif->message = 'Observer: ' . Auth::user()->name . ' Set Your Group Task: ' . $task->title . ' To Emergency';
                $notif->type = 'info';
                $notif->save();
            }
    ...
    public function ObserverTasksSetOverTimeAutomation(Request $request){
        $toggle = $request->status;
        $member = Member::where('user_id', Auth::id())->first();
        $dept = Department::where('id', $member->department_id)->first();
        if(!$member){
            return response()->json(['status' => 'error', 'message' => 'This Member Is Not Existing.']);
        }
        if(!$dept){
            return response()->json(['status' => 'error', 'message' => 'This Department Is Not Existing.']);
        }
        if($dept->overtime_auto === $toggle){
            return response()->json(['status' => 'error', 'message' => 'This Department Is Already Set As: '.$toggle]);
        }

        $dept->overtime_auto = $toggle;
        $dept->save();

        Log::create([
            'name' => Auth::user()->name,
            'action' => "Set Task To Overtime Automation to: {$toggle} Department: {$dept->name}",
            'description' => now()->format('Y-m-d'),
        ]);
    ...
    public function ObserverTasksGetWorkTimeSettings(Request $request){
        $dept = $request->dept;

        $department = Department::find($dept);

        if(!$department){
            return response()->json(['status' => 'error', 'message' => 'Department Not Existing']);
        }
        ...
        return response()->json([
            'department' => [
                ...
                'start_day' => $department->start_day,
                'end_day' => $department->end_day,
                'start_time' => Carbon::parse($department->start_time)->format('H:i'),
                'end_time' => Carbon::parse($department->end_time)->format('H:i'),
            ]
        ]);
    }

    public function ObserverTasksSetWorkTimeAutomation(Request $request){
        $validator = Validator::make($request->all(), [
            'start_day' => ['required'],
            'end_day' => ['required'],
            'start_time' => ['required', 'date_format:H:i'],
        ...
        $department->start_day = $start_day;
        $department->end_day = $end_day;
        $department->start_time = $start_time;
        $department->end_time = $end_time;
        $department->save();

        Log::create([
            'name' => Auth::user()->name,
            'action' => "Set Working Time In Department: {$department->name}",
            'description' => now()->format('Y-m-d'),
        ]);
    ...
    public function ObserverTasksRequestOvertimeTask(Request $request){
        $task_id = $request->task;
    ...
    public function ObserverTasksAcceptOvertimeRequest(Request $request){
        $task_id = $request->task;
            ...
            if($task->type == "Group"){
                ...
                if($group->isNotEmpty()){
                    foreach($group as $member){
                        ...
                        $notif = new Notification();
                        $notif->user_id = $member->user_id;
                        $notif->message = 'Observer: ' . Auth::user()->name . ' Accept Overtime Request Task: ' . $task->title ;
                        $notif->type = 'info';
                        $notif->save();
    ...
    public function ObserverTasksDeclineOvertimeRequest(Request $request){
        $task_id = $request->task;
            ...
            if($task->type == "Group"){
                ...
                if($group->isNotEmpty()){
                    foreach($group as $member){
                        ...
                        $notif = new Notification();
                        $notif->user_id = $member->user_id;
                        $notif->message = 'Observer: ' . Auth::user()->name . ' Decline Overtime Request Task: ' . $task->title ;
                        $notif->type = 'info';
                        $notif->save();
    ...
    public function ObserverTasksUnlinkTask(Request $request){
        $task_id = $request->task;
        ...
        if($task_to->type === 'Solo'){
            ...
            $notif = new Notification();
            $notif->user_id = $solo->user_id;
            $notif->message = 'Observer: ' . Auth::user()->name . ' Unlink Task: ' . $task->title . ' To Your Task: '.$task_to->title;
            $notif->type = 'info';
            $notif->save();
    ...
    public function ObserverTasksArchiveDistributedTask(Request $request){
    ...
    public function ObserverTasksArchiveCompletedTask(Request $request){
        $task = Task::find($request->task);
    ...
    public function ObserverTasksRetrievetask(Request $request){
        $task = Task::find($request->task);
    ...
    public function ObserverTasksDeletetask(Request $request){
        $task = Task::find($request->task);
    ...
    public function ObserverChatSendTaskContactMessage(Request $request){
        $validator = Validator::make($request->all(), [
...
//region Department
    public function ObserverDepartment(){
        ...
        return view('observer.observer_department', compact('dept'));
    }

    public function ObserverAddAccount(Request $request){
        $request->merge([
        ...
        $validator = Validator::make($request->all(), [
            ...
            'role' => ['required', 'string', 'in:admin,head,observer,employee,intern'],
            'password' => [
                'required',
                'string',
                'min:8',
        ...
        if($checkUser){
            return response()->json(['status' => 'userExist']);
        }
        ...
        $id = Member::where('user_id', Auth::user()->id)->first();

        $member = new Member();
        $member->department_id = $id->department_id;
        $member->user_id = $get->id;
        $member->profile = $get->photo;
        $member->name = $get->name;
        $member->role = $get->role;

        $log = new Log();
        $log->name = Auth::user()->name;
        $log->action = "User: ".Auth::user()->name." ID: ".Auth::user()->id . " create new ".$request->input('role')." on his department";
        $log->description = date('Y-m-d');
        $log->save();
...
//region Calendar
    ...
    public function ObserverCalendar(){
        return view('observer.observer_calendar');
    }

    public function ObserverCalendarViewTaskDate(){
        $member = Member::where('user_id', Auth::user()->id)->first();
        $events = [];
        if($member){
            $task = Task::where('department_id', $member->department_id)->whereIn('status', ['Ongoing', 'Overdue'])->get();
            foreach($task as $row){
    ...
    public function ObserverCalendarSaveEvent(Request $request){
        $validator = Validator::make($request->all(), [
    ...
    public function ObserverCalendarViewPrivateEventDate(){
    ...
    public function ObserverCalendarViewDepartmentEventDate(){
        $member = Member::where('user_id', Auth::user()->id)->first();
    ...
    public function ObserverCalendarViewAnnouncementEventDate(){
    ...
    public function ObserverCalendarRemoveEvent(Request $request){
...
//region Personal Table
    public function ObserverPersonalTable(){
        ...
        return view('observer.observer_personal_table', compact('tasks', 'favorites', 'important', 'tag', 'personalNotes', 'relatedTasks', 'notesCount', 'personalPrivateNotes'));
    }

    public function ObserverPersonalTableSort(Request $request){
    ...
    public function ObserverPersonalTableMarkTask(Request $request){
    ...
    public function ObserverPersonalTableUpdateSort(Request $request){
        $user = Auth::id();
        $type = $request->input('type');
        if($type == 'task'){
    ...
    public function ObserverPersonalTableTaskFavorites(Request $request){
        $task_id = $request->task;
    ...
    public function ObserverPersonalTableTaskImportant(Request $request){
        $task_id = $request->task;
    ...
    public function ObserverPersonalTableTaskTag(Request $request){
        $task_id = $request->task;
    ...
    public function ObserverPersonalTableTaskNotes(Request $request){
        $user_id = Auth::id();
        $validator = Validator::make($request->all(), [
            'title' => 'required|string|max:225',
        ]);
    ...
    public function ObserverPersonalTableTaskNotesRemove(Request $request){
        $task_id = $request->task;
    ...
    public function ObserverPersonalTableNotesRemove(Request $request){
        $note_id = $request->notes;
    ...
    public function ObserverPersonalTableEditNotes(Request $request){
        $validator = Validator::make($request->all(), [
            'title' => 'required|string|max:225',
    ...
    public function ObserverPersonalTableCreateNotes(Request $request){
        $user_id = Auth::id();
        $validator = Validator::make($request->all(), [
            'title' => 'required|string|max:225',
            'description' => 'nullable|string|max:225',
...
//region Chat
    public function ObserverChat(){
        ...
        return view('observer.observer_chat', compact('users', 'chatResult', 'rooms', 'roomsEnd'));
    }

    public function ObserverChatSendContactMessage(Request $request){
        $validator = Validator::make($request->all(), [
            'message' => 'nullable|string',
            'attachments' => 'nullable|array|max:20', // Limit attachments to 20
            'attachments.*' =>  'file|mimes:jpg,jpeg,png,gif,webp,bmp,svg,ico,tiff,psd,ai,eps,pdf,doc,docx,txt,ppt,pptx,xls,xlsx,odt,ods,odp,rtf,csv,zip,rar,7z|max:10240', // 10MB max per file
    ...
    public function ObserverViewChats(Request $request){
    ...
    public function ObserverChatSendMessage(Request $request){
        $validator = Validator::make($request->all(), [
            'message' => 'nullable|string',
            'attachments' => 'nullable|array|max:20', // Limit attachments to 20
            'attachments.*' => 'file|mimes:jpg,jpeg,png,gif,webp,bmp,svg,ico,tiff,psd,ai,eps,pdf,doc,docx,txt,ppt,pptx,xls,xlsx,odt,ods,odp,rtf,csv,zip,rar,7z|max:10240', // 10MB max per file
    ...
    public function ObserverChatCheckWhoSeen(Request $request){
    ...
    public function ObserverCheckMessageAttachment(Request $request){
        $messageId = $request->message;
    ...
    public function ObserverChatRepliedUser(Request $request){
        $messageId = $request->message;
    ...
    public function ObservercheckMessageReply(Request $request){
        $messageId = $request->message;
    ...
    public function ObserverChatGetTaskInfo(Request $request){
        $task_id = $request->task;
    ...
    public function ObserverGetEditMessage(Request $request){
        $messageId = $request->message;
        $message = Message::where('id', $messageId)->first();
    ...
    public function ObserverChatEditMessage(Request $request){
        $validator = Validator::make($request->all(), [
    ...
    public function ObserverViewEditMessage(Request $request){
        $messageId = $request->message;
    ...
    public function ObserverViewMessageContact(Request $request){
        $userId = Auth::id();
        $chats = ChatParticipant::where('chat_participants.user_id', $userId)
    ...
    public function ObserverChatSendForwardMessage(Request $request){
        $messageId = $request->message;
        $chatId = $request->chat;
    ...
    public function ObserverCheckWhoForward(Request $request){
        $messageId = $request->message;
        $message = Message::where('id', $messageId)->first();
    ...
    public function ObserverChatUnsendMessage(Request $request){
    ...
    public function ObserverChatPinMessage(Request $request){
        $messageId = $request->message;
        $chatId = $request->chat;
    ...
    public function ObserverChatUnpinMessage(Request $request){
        $messageId = $request->message;
        $chatId = $request->chat;
        $message = Message::where('id', $messageId)->whereNotIn('is_unsend', [1, 2])->first();
    ...
    public function ObserverChatReact(Request $request){
    ...
    public function ObserverViewPinnedMessage(Request $request){
        $chat_id = $request->chat;
    ...
    public function ObserverChatSetNickname(Request $request){
    ...
    public function ObserverChatSetMutedChat(Request $request){
        $chat_id = $request->chat_id;
    ...
    public function ObserverChatSearchMessageValue(Request $request) {
    ...
    public function ObserverChatSaveMeeting(Request $request) {
        try {
            $validator = Validator::make($request->all(), [
                'name' => 'required|string|max:255',
    ...
    public function ObserverChatRemoveMeeting(Request $request){
    ...
    public function ObserverChatCreateGroupMessage(Request $request){
    ...
    public function ObserverChatSetConvoImage(Request $request){
    ...
    public function ObserverChatUnsetConvoImage(Request $request){
        $chat_id = $request->chat;
    ...
    public function ObserverChatSetConvoName(Request $request){
    ...
    public function ObserverChatUnsetConvoName(Request $request){
    ...
    public function ObserverChatAddNewMemberGroup(Request $request) {
        $chat_id = $request->chat;
    ...
    public function ObserverChatToggleAsAdmin(Request $request){
        $chat = $request->chat;
        $user = $request->user;
        $type = $request->type;
    ...
    public function ObserverChatRemoveFromGroup(Request $request){
    ...
    public function ObserverChatLeaveConversation(Request $request){
        DB::transaction(function () use ($request) {
            $chat_id = $request->chat;
            $user_id = Auth::id();
    ...
    public function ObserverChatUnsetChatIsHere(){
        $user_id = Auth::id();
    ...
    public function ObserverChatSetChatIsHere(){
        $user_id = Auth::id();
    ...
    public function ObserverChatRemoveIsHere(){
        $user_id = Auth::id();
